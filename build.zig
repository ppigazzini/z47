...
fn registerNativeUnitTests(b: *std.Build) void {
    const pure_modules = [_][]const u8{
        ...
        "zig_src/engine/kernel/block_availability_pure.zig",
        "zig_src/engine/kernel/flag_classify.zig",
        "zig_src/engine/kernel/vector_shape.zig",
        "zig_src/engine/kernel/register_range_ops.zig",
        "zig_src/engine/kernel/data_file_bytes.zig",
        "zig_src/engine/kernel/name_glyph.zig",
        "zig_src/engine/kernel/word_scan.zig",
        "zig_src/engine/kernel/real34_sign.zig",
        "zig_src/engine/kernel/reserved_register.zig",
        "zig_src/engine/kernel/solver_status.zig",
        "zig_src/engine/kernel/flag_bits.zig",
        "zig_src/engine/kernel/keyboard_hit_test.zig",
        "zig_src/frontier/status_bar_geometry.zig",
        "zig_src/frontier/display/softmenus/softmenu_math.zig",
        "zig_src/engine/kernel/stack_runtime_register_range.zig",
