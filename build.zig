...
fn registerNativeUnitTests(b: *std.Build) void {
    const pure_modules = [_][]const u8{
        ...
        "zig_src/state/register_id_valid.zig",
        "zig_src/state/data_file_bytes.zig",
        "zig_src/state/name_glyph.zig",
        "zig_src/state/word_scan.zig",
        "zig_src/state/saved_register.zig",
        "zig_src/state/align_blocks.zig",
        "zig_src/state/real34_sign.zig",
        "zig_src/state/matrix_element_count.zig",
        "zig_src/state/menu_doublepress.zig",
        "zig_src/state/reserved_register.zig",
        "zig_src/state/statusbar_flags.zig",
        "zig_src/state/solver_status.zig",
        "zig_src/state/flag_bits.zig",
        "zig_src/state/sys_flag_bits.zig",
        "zig_src/state/shuffle_order.zig",
        "zig_src/state/alpha_case_select.zig",
        "zig_src/state/radix_mark.zig",
        ...
        "zig_src/frontier/str_stpcpy.zig",
        "zig_src/frontier/str_append.zig",
        ...
        "zig_src/frontier/type_is_number.zig",
        "zig_src/frontier/softmenu_math.zig",
        "zig_src/frontier/substring_search.zig",
        "zig_src/frontier/hp_range_shift.zig",
        "zig_src/frontier/glyph_advance.zig",
        "zig_src/frontier/pem_offset.zig",
        "zig_src/frontier/plot_range_zero.zig",
        "zig_src/frontier/plot_range_degenerate.zig",
        "zig_src/frontier/plot_tick_snap.zig",
        ...
        "zig_src/frontier/print_tab.zig",
        ...
        "zig_src/mathematics/math_matrix_kinds.zig",
        ...
        "zig_src/frontier/glyph_font_search.zig",
        ...
        "zig_src/frontier/printer_char_map.zig",
        "zig_src/frontier/numeral_grouping.zig",
        "zig_src/frontier/numeral_decode.zig",
        "zig_src/frontier/glyph_case.zig",
        "zig_src/frontier/alpha_substring.zig",
        ...
        "zig_build/host/space_label.zig",
        "zig_build/host/caps_strip.zig",
