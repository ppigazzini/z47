...
fn registerNativeUnitTests(b: *std.Build) void {
    const pure_modules = [_][]const u8{
        ...
        "zig_src/engine/numeric/compare/real_predicates.zig",
        "zig_src/engine/numeric/compare/register_classify.zig",
        "zig_src/engine/numeric/number_theory/small_prime_list.zig",
        "zig_src/engine/numeric/matrix/kinds.zig",
        "zig_src/engine/numeric/compare/type_encode.zig",
        "zig_src/engine/numeric/matrix/mim_util.zig",
