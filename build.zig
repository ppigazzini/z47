...
fn registerNativeUnitTests(b: *std.Build) void {
    const pure_modules = [_][]const u8{
        ...
        "zig_src/core/kernel/data_file_bytes.zig",
        "zig_src/core/kernel/name_glyph.zig",
        "zig_src/core/kernel/word_scan.zig",
        "zig_src/core/kernel/real34_sign.zig",
        "zig_src/core/kernel/reserved_register.zig",
        "zig_src/core/kernel/solver_status.zig",
        "zig_src/core/kernel/flag_bits.zig",
        "zig_src/core/kernel/keyboard_hit_test.zig",
        "zig_src/shell/display/statusbar/status_bar_geometry.zig",
        "zig_src/shell/display/softmenus/softmenu_math.zig",
        "zig_src/core/kernel/stack_runtime_register_range.zig",
