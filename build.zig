...
const dist_steps = @import("build/dist.zig");
const firmware_steps = @import("build/firmware.zig");
const host_steps = @import("build/host.zig");
const object_manifest = @import("build/object_manifest.zig");
...
fn registerNativeUnitTests(b: *std.Build) void {
    const pure_modules = [_][]const u8{
        "src/abi/float_format.zig",
        "src/abi/types.zig",
        "src/core/numeric/integer/core.zig",
        "src/core/persist/calc_state_progmem.zig",
        "src/core/state/register_metadata/register_metadata_payload_bytes.zig",
        "src/core/state/register_metadata/register_descriptor_codec.zig",
        "src/core/memory/block_availability_pure.zig",
        "src/core/state/flags/flag_classify.zig",
        "src/core/persist/vector_shape.zig",
        "src/core/state/stack/register_range_ops.zig",
        "src/core/persist/data_file_bytes.zig",
        "src/core/state/register_metadata/name_glyph.zig",
        "src/core/persist/word_scan.zig",
        "src/core/state/stack/real34_sign.zig",
        "src/core/state/register_metadata/reserved_register.zig",
        "src/core/input/solver_status.zig",
        "src/core/state/flags/flag_bits.zig",
        "src/core/input/keyboard_hit_test.zig",
        "src/shell/display/statusbar/status_bar_geometry.zig",
        "src/shell/display/softmenus/softmenu_math.zig",
        "src/core/state/runtime/stack_runtime_register_range.zig",
        "src/core/numeric/compare/real_predicates.zig",
        "src/core/numeric/compare/register_classify.zig",
        "src/core/numeric/number_theory/small_prime_list.zig",
        "src/core/numeric/matrix/kinds.zig",
        "src/core/numeric/compare/type_encode.zig",
        "src/core/numeric/matrix/mim_util.zig",
        "src/abi/int_math.zig",
        "src/abi/shortint_arith.zig",
        "src/abi/sci_format.zig",
        "src/abi/glyph_code.zig",
        "src/abi/complex_text.zig",
        "src/abi/pcg32.zig",
        "src/abi/c47_string.zig",
        "src/shell/input/keycode_remap.zig",
        "src/shell/display/lr_selection.zig",
        "src/shell/plot/plot_viewport.zig",
        ...
        "src/shell/input/adm_encoding.zig",
        "src/shell/plot/plot_regression_selection.zig",
        "src/shell/word_size_math.zig",
        "src/shell/print/printer_char_map.zig",
        "src/core/text/numeral_grouping.zig",
        "src/shell/program/numeral_decode.zig",
        "src/core/text/glyph_case.zig",
        "src/core/text/alpha_substring.zig",
        "src/shell/convert/fraction_encode.zig",
        "src/core/text/label_truncate.zig",
        "src/shell/vbat_integrator.zig",
        "src/shell/program/program_step_opcode.zig",
        "src/shell/plot/plot_zoom.zig",
        "src/core/text/str_concat.zig",
        "src/core/text/word_break.zig",
        "src/core/text/gap_char_codec.zig",
        "src/core/text/integer_separators.zig",
        "src/shell/matrix_editor/matrix_wrap.zig",
        "src/shell/store_register_range.zig",
        "src/shell/program/ks_register_remap.zig",
        "src/core/text/gap_insert.zig",
        "src/core/text/display_string_transform.zig",
        "src/shell/convert/conversion_name_codec.zig",
        "src/core/text/string_edit.zig",
        "src/core/text/glyph_text_lookup.zig",
        "src/core/text/glyph_export.zig",
        "src/shell/register_data_type.zig",
        "src/abi/block_math.zig",
        "src/abi/trap_panic.zig",
        "src/abi/line_parse.zig",
        "src/shell/pool_poison.zig",
    };
