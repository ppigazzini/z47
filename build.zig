...
fn registerNativeUnitTests(b: *std.Build) void {
    const pure_modules = [_][]const u8{
        ...
        "zig_src/core/text/glyph_font_search.zig",
        ...
        "zig_src/core/text/numeral_grouping.zig",
        "zig_src/shell/program/numeral_decode.zig",
        "zig_src/core/text/glyph_case.zig",
        "zig_src/core/text/alpha_substring.zig",
        "zig_src/shell/convert/fraction_encode.zig",
        "zig_src/core/text/label_truncate.zig",
        "zig_src/shell/vbat_integrator.zig",
        "zig_src/shell/program/program_step_opcode.zig",
        "zig_src/shell/plot/plot_zoom.zig",
        "zig_src/core/text/str_concat.zig",
        "zig_src/core/text/word_break.zig",
        "zig_src/core/text/gap_char_codec.zig",
        "zig_src/core/text/integer_separators.zig",
        ...
        "zig_src/core/text/gap_insert.zig",
        "zig_src/core/text/display_string_transform.zig",
        "zig_src/shell/convert/conversion_name_codec.zig",
        "zig_src/core/text/string_edit.zig",
        "zig_src/core/text/glyph_text_lookup.zig",
