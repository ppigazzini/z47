...
fn registerNativeUnitTests(b: *std.Build) void {
    const pure_modules = [_][]const u8{
        ...
        "zig_src/shell/status_bar_geometry.zig",
        ...
        "zig_src/shell/plot_viewport.zig",
        ...
        "zig_src/shell/numeral_decode.zig",
        ...
        "zig_src/shell/matrix_wrap.zig",
        "zig_src/shell/store_register_range.zig",
        "zig_src/shell/ks_register_remap.zig",
