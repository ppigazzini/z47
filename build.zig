...
fn registerNativeUnitTests(b: *std.Build) void {
    const pure_modules = [_][]const u8{
        ...
        "zig_src/kernel/calc_state_progmem.zig",
        "zig_src/kernel/register_metadata_payload_bytes.zig",
        "zig_src/kernel/register_descriptor_codec.zig",
        "zig_src/kernel/block_availability_pure.zig",
        "zig_src/kernel/flag_classify.zig",
        "zig_src/kernel/vector_shape.zig",
        "zig_src/kernel/register_range_ops.zig",
        "zig_src/kernel/data_file_bytes.zig",
        "zig_src/kernel/name_glyph.zig",
        "zig_src/kernel/word_scan.zig",
        "zig_src/kernel/real34_sign.zig",
        "zig_src/kernel/reserved_register.zig",
        "zig_src/kernel/solver_status.zig",
        "zig_src/kernel/flag_bits.zig",
        "zig_src/kernel/keyboard_hit_test.zig",
        "zig_src/frontier/status_bar_geometry.zig",
        "zig_src/frontier/display/softmenus/softmenu_math.zig",
        "zig_src/kernel/stack_runtime_register_range.zig",
        "zig_src/engine/numeric/math_real_predicates.zig",
        "zig_src/engine/numeric/register_classify.zig",
        "zig_src/engine/numeric/small_prime_list.zig",
        "zig_src/engine/numeric/matrix/kinds.zig",
        "zig_src/engine/numeric/math_type_encode.zig",
        "zig_src/engine/numeric/math_mim_util.zig",
        ...
        "zig_src/frontier/input/keycode_remap.zig",
        "zig_src/frontier/display/lr_selection.zig",
        "zig_src/frontier/plot_viewport.zig",
        "zig_src/frontier/convert/conversion_pairs.zig",
        "zig_src/frontier/display/fonts/glyph_font_search.zig",
        "zig_src/frontier/program/program_step_width.zig",
        "zig_src/frontier/print/printer_text_width.zig",
        "zig_src/frontier/print/printer_glyph_search.zig",
        "zig_src/engine/analysis/label_range.zig",
        "zig_src/frontier/timer_math.zig",
        "zig_src/frontier/input/adm_encoding.zig",
        "zig_src/frontier/plot/plot_regression_selection.zig",
        "zig_src/frontier/word_size_math.zig",
        "zig_src/frontier/print/printer_char_map.zig",
        "zig_src/frontier/display/text/numeral_grouping.zig",
        "zig_src/frontier/numeral_decode.zig",
        "zig_src/frontier/display/text/glyph_case.zig",
        "zig_src/frontier/display/text/alpha_substring.zig",
        "zig_src/frontier/convert/fraction_encode.zig",
        "zig_src/frontier/display/text/label_truncate.zig",
        "zig_src/frontier/vbat_integrator.zig",
        "zig_src/frontier/program/program_step_opcode.zig",
        "zig_src/frontier/plot_zoom.zig",
        "zig_src/frontier/display/text/str_concat.zig",
        "zig_src/frontier/display/text/word_break.zig",
        "zig_src/frontier/display/text/gap_char_codec.zig",
        "zig_src/frontier/display/text/integer_separators.zig",
        "zig_src/frontier/matrix_wrap.zig",
        "zig_src/frontier/store_register_range.zig",
        "zig_src/frontier/ks_register_remap.zig",
        "zig_src/frontier/display/text/gap_insert.zig",
        "zig_src/frontier/display/text/display_string_transform.zig",
        "zig_src/frontier/convert/conversion_name_codec.zig",
        "zig_src/frontier/string_edit.zig",
        "zig_src/frontier/display/text/glyph_text_lookup.zig",
        "zig_src/frontier/display/text/glyph_export.zig",
