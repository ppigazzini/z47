...
#define tamArrows (labelText || tam.mode == TM_FLAGW || tam.mode == TM_FLAGR)
  ...
  if(     (CTRL_State != 65536 || allowAltGrKey)
     ...
     && (    calcMode == CM_NORMAL
         ...
         ||  calcMode == CM_PEM
         ||  calcMode == CM_TIMER
         || (calcMode == CM_MIM && (event_key_strip_capslock == GDK_KEY_m || event_key_strip_capslock == GDK_KEY_r))//matrix editor: STO and RCL shortcuts allowed
...
//C47 & R47============
  ...
  else if(shortCutCommand(w, event_key_command, GDK_KEY_m           /* m 109   */    ,                                  shortcutProfile == USER_C47,  EXITIFNIM,          tam.mode,    "",   "06",           0b1000000001101,         -1,              ITM_STO ))        {goto returnKeyPressedFalse;} //                   [m]emory
  else if(shortCutCommand(w, event_key_command, GDK_KEY_r           /* r 114   */    ,                                  shortcutProfile == USER_C47,  EXITIFNIM,          tam.mode,    "",   "07",           0b1000000001101,         -1,              ITM_RCL ))        {goto returnKeyPressedFalse;} //                      [r]cl
...
//                                             PC_GTK3_code                                                          Logic Condition to enable line,  Close NIM,   Disabling state,  Shift/KEYno, Valid CalcMode       requiredCalcMode2     itemForRunFunction
  ...
  else if(shortCutCommand(w, event_key_command, GDK_KEY_m           /* m 109   */    ,                                  shortcutProfile == USER_R47,  EXITIFNIM,          tam.mode,    "",   "06",           0b1000000001101,         -1,              ITM_STO ))        {goto returnKeyPressedFalse;} //                   [m]emory
  else if(shortCutCommand(w, event_key_command, GDK_KEY_r           /* r 114   */    ,                                  shortcutProfile == USER_R47,  EXITIFNIM,          tam.mode,    "",   "07",           0b1000000001101,         -1,              ITM_RCL ))        {goto returnKeyPressedFalse;} //                      [r]cl
