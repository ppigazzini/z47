...
TO_QSPI const uint16_t refreshStateFlags[] = {       //these flags need to update the corresponding softkey status
  ...
  FLAG_NUMLOCK, FLAG_CPXMULT, FLAG_ERPN, FLAG_CARRY, FLAG_OVERFLOW, FLAG_FRCYC, FLAG_M_ALL,
  ...
  FLAG_PRMS, FLAG_PINTG, FLAG_PDIFF, FLAG_PSHADE, FLAG_PL_2L, FLAG_AUTOVALID
};
