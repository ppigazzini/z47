...
- docs-only maintainer doc change rooted in `zig_docs/`, `README.md`,
  `BUILD.md`, or `ZIG-README.md`: verify every key claim against live files,
  then rerun `zig build --help --summary none` if target names or options are
  described
...
- boundary or leaf-rewrite change: `zig build logical_shortint_parity --summary none`
...
2. `zig build both --summary none`
3. `zig build test --summary none`
4. `zig build generated --summary none`
5. `zig build both_asan --summary none`
6. `zig build test_asan --summary none`
7. `zig build docs --summary none`
8. `zig build dmcp --summary none`
9. `zig build dmcpr47 --summary none`
10. `zig build dmcp5 --summary none`
11. `zig build dmcp5r47 --summary none`
12. `zig build dist_linux --summary none`
