...
- run `logical_shortint_parity`, `stack_state_parity`,
  `register_metadata_parity`, `both`, `testPgms`, `test`, `generated`,
...
- run `logical_shortint_parity`, `stack_state_parity`,
  `register_metadata_parity`, `both`, `test`, and `generated`
...
| Linux host parity | `zig build logical_shortint_parity && zig build stack_state_parity && zig build register_metadata_parity && zig build both && zig build test && zig build generated` |
