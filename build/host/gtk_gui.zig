...
pub fn addToModule(
    ...
    const gui_runtime = b.addObject(.{
        ...
        .root_module = b.createModule(.{
            .root_source_file = b.path("build/host/gtk_gui_runtime.zig"),
            .target = target,
            .optimize = optimize,
            .link_libc = true,
    ...
    const hal_runtime = b.addObject(.{
        ...
        .root_module = b.createModule(.{
            .root_source_file = b.path("build/host/gtk_hal_runtime.zig"),
            .target = target,
            .optimize = optimize,
            .link_libc = true,
        }),
    ...
    const io_runtime = b.addObject(.{
        ...
        .root_module = b.createModule(.{
            .root_source_file = b.path("build/host/gtk_io_runtime.zig"),
            .target = target,
            .optimize = optimize,
            .link_libc = true,
        }),
    ...
    const lcd_runtime = b.addObject(.{
        ...
        .root_module = b.createModule(.{
            .root_source_file = b.path("build/host/gtk_lcd_runtime.zig"),
            .target = target,
            .optimize = optimize,
            .link_libc = true,
        }),
