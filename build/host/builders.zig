...
// to build/tests/testsuite_hal.zig. These helpers drop the ported .c
...
pub fn addTestSuiteHalObject(
    ...
    return b.addObject(.{
        ...
        .root_module = b.createModule(.{
            .root_source_file = b.path("build/tests/testsuite_hal.zig"),
            .target = target,
            .optimize = optimize,
            .link_libc = true,
        }),
...
// build/tests/testsuite_main.zig can own the entry point and install the
...
pub fn addTestSuiteMainObject(
    ...
    const module = b.createModule(.{
        .root_source_file = b.path("build/tests/testsuite_main.zig"),
        .target = target,
        .optimize = optimize,
        .link_libc = true,
    });
