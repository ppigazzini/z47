...
pub fn addGeneratorSteps(
    ...
    const raster_fonts_gen = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            .root_source_file = b.path("build/tools/ttf2_raster_fonts.zig"),
            .target = host_target,
            .optimize = optimize,
            .link_libc = true,
        }),
    ...
    const generate_constants = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            .root_source_file = b.path("build/tools/generate_constants.zig"),
            .target = host_target,
            .optimize = optimize,
            .link_libc = true,
        }),
    ...
    const generate_catalogs = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            .root_source_file = b.path("build/tools/generate_catalogs.zig"),
            .target = host_target,
            .optimize = optimize,
            .link_libc = true,
        }),
    ...
    const generate_testpgms = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            .root_source_file = b.path("build/tools/generate_testpgms.zig"),
            .target = host_target,
            .optimize = optimize,
            .link_libc = true,
        }),
