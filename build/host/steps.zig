...
fn addMathLnComplexOracle(
    ...
    exe.root_module.addCSourceFile(.{ .file = b.path("build/tests/math_wrappers/math_ln_complex_reference.c"), .flags = core_c_flags });
...
pub fn registerSteps(b: *std.Build, context: host_types.Context, optimize: std.builtin.OptimizeMode) host_types.SimulatorOutputs {
    ...
    const simulator_smoke_cmd = build_common.addBashCommandFmt(b,
        \\bash build/host/simulator_smoke.sh zig-out/bin/c47 C47
        \\bash build/host/simulator_smoke.sh zig-out/bin/r47 R47
    , .{});
    ...
    const run_logical_boolean_ops_suite = addTestSuiteRun(b, test_suite, "build/tests/testSuiteList_logical_boolean_ops.txt");
    ...
    const keyboard_entry_harness = host_builders.addFullCoreHarness(
        ...
        context.host_target,
        "keyboardEntry",
        "build/tests/keyboard_state/keyboard_entry_harness.c",
        optimize,
        context.core_sources,
        context.test_sources,
        context.common,
    ...
    coverage_harness.root_module.addCSourceFile(.{
        .file = b.path("build/tests/coverage/sancov_handler.c"),
        .flags = &.{},
    });
    ...
    const charstring_diff_harness = host_builders.addFullCoreHarness(
        ...
        context.host_target,
        "charstringDiff",
        "build/tests/charstring_diff/charstring_diff_harness.c",
        optimize,
        context.core_sources,
        context.test_sources,
        context.common,
    ...
    charstring_diff_harness.root_module.addCSourceFile(.{
        .file = b.path("build/tests/charstring_diff/charstring_diff_oracle.c"),
        .flags = &.{},
    });
    ...
    const format_parity_exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            .root_source_file = b.path("build/tests/format/format_parity.zig"),
            .target = context.host_target,
            .optimize = optimize,
            .link_libc = true,
            .imports = &.{
                .{ .name = "float_format", .module = b.createModule(.{
                    .root_source_file = b.path("src/abi/float_format.zig"),
                    .target = context.host_target,
                    .optimize = optimize,
                }) },
            },
    ...
    const pgm_run_harness = host_builders.addFullCoreHarness(
        ...
        context.host_target,
        "pgmRun",
        "build/tests/pgm_run/pgm_run_harness.c",
        optimize,
        context.core_sources,
        context.test_sources,
        context.common,
    ...
    const state_load_harness = host_builders.addFullCoreHarness(
        ...
        context.host_target,
        "stateLoadFuzz",
        "build/tests/calc_state/state_load_harness.c",
        optimize,
        context.core_sources,
        context.test_sources,
        context.common,
    ...
    const progmem_test = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("src/core/persist/calc_state_progmem.zig"),
            .target = context.host_target,
            .optimize = optimize,
        }),
    });
    ...
    const ringbuffer_test_module = b.createModule(.{
        .root_source_file = b.path("src/core/input/keyboard_state_ringbuffer.zig"),
        .target = context.host_target,
        .optimize = optimize,
    });
    ...
    abi_layout_module.addCSourceFile(.{
        .file = b.path("build/tests/abi_layout/abi_layout_c_asserts.c"),
        .flags = &.{
            "-DPC_BUILD=1",
    ...
    const distribution_owners_module = b.createModule(.{
        .root_source_file = b.path("src/shell/distributions/distributions_test_owners.zig"),
        .target = context.host_target,
        .optimize = optimize,
    });
    ...
    const distribution_parity = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            .root_source_file = b.path("build/tests/distributions/distribution_parity.zig"),
            .target = context.host_target,
            .optimize = optimize,
            .link_libc = true,
            .imports = &.{
    ...
    keyboard_statusbar_flags_regression.root_module.addIncludePath(b.path("bridge/state"));
    keyboard_statusbar_flags_regression.root_module.addCSourceFile(.{
        .file = b.path("build/tests/keyboard_statusbar_flags_regression.c"),
        .flags = &.{},
    });
