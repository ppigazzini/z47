...
// timers, and enters the GTK main loop. Retires build/host/gtk_c47_gtk_legacy.c.
...
const SCREEN_REFRESH_PERIOD: c_uint = 100; // defines.h: 160 DMCP / 100 host, and c47-gtk.c is the host build
