...
pub fn addRuntimeObjectsWithOptions(
    ...
    return .{
        .bit_manipulation = addRuntimeObject(b, target, optimize, name_prefix, "bit-manipulation", "src/core/numeric/integer/bit_manipulation.zig", options),
        .logical_boolean_ops = addRuntimeObject(b, target, optimize, name_prefix, "logical-boolean-ops", "src/core/numeric/integer/logical_boolean_ops.zig", options),
        .rotate_bits = addRuntimeObject(b, target, optimize, name_prefix, "rotate-bits", "src/core/numeric/integer/rotate_bits.zig", options),
    };
}
...
pub fn addParityExecutable(
    ...
    exe.root_module.addIncludePath(b.path("build/tests"));
    exe.root_module.addCSourceFile(.{ .file = b.path("build/tests/logical_shortint_fake_runtime.c"), .flags = &.{} });
    exe.root_module.addCSourceFile(.{ .file = b.path("build/tests/logical_shortint_parity.c"), .flags = &.{} });
...
pub fn addRotateBitsParityExecutable(
    ...
    exe.root_module.addCSourceFile(.{ .file = b.path("build/tests/rotate_bits/rotate_bits_parity.c"), .flags = &.{} });
