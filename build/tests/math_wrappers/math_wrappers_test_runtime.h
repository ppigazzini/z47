...
typedef struct {
  ...
  int32_t final_register_complex_real_value;
  uint8_t final_register_complex_real_bits;
  int32_t final_register_complex_imag_value;
  uint8_t final_register_complex_imag_bits;
  uint32_t final_register_y_data_type;
  uint32_t final_register_y_tag;
  int32_t final_register_y_real34_value;
  uint8_t final_register_y_real34_bits;
  int32_t final_register_y_complex_real_value;
  uint8_t final_register_y_complex_real_bits;
  int32_t final_register_y_complex_imag_value;
  uint8_t final_register_y_complex_imag_bits;
  uint32_t final_register_z_data_type;
  uint32_t final_register_z_tag;
  int32_t final_register_z_real34_value;
  uint8_t final_register_z_real34_bits;
  int32_t final_register_z_complex_real_value;
