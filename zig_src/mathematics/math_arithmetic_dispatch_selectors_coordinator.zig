...
const selectors_add_sub = @import("math_arithmetic_dispatch_selectors_add_sub.zig");
const selectors_mul_div = @import("math_arithmetic_dispatch_selectors_mul_div.zig");
