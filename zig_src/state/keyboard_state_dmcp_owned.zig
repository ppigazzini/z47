...
// that the keyboard_state_legacy.c bridge still compiles out of keyboard.c. These
// are not reachable from the host sim or testSuite (they bind DMCP key-event and
