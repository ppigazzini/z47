...
// Re-exported: 178 files reach these as `abi.types.X`, and moving a declaration
// between files inside `abi/` is not a reason to touch any of them.
pub const DECNUMUNITS = primitives.DECNUMUNITS;
pub const Real = primitives.Real;
pub const Real34 = primitives.Real34;
pub const RealContext = primitives.RealContext;
pub const Complex = primitives.Complex;
pub const Complex34 = primitives.Complex34;
pub const CalcKey = primitives.CalcKey;
pub const MatrixHeader = primitives.MatrixHeader;
pub const DtConfigDescriptor = primitives.DtConfigDescriptor;
pub const StrLgIntHeader = primitives.StrLgIntHeader;
pub const NormKey = primitives.NormKey;
pub const Pcg32Random = primitives.Pcg32Random;
