...
comptime {
    ...
    _ = @import("display/fonts/fonts.zig");
    ...
    _ = @import("display/sort.zig");
    _ = @import("frontier_error.zig");
    _ = @import("frontier_lbl_gto_xeq.zig");
    _ = @import("display/text/string_funcs.zig");
    ...
    _ = @import("display/screen.zig");
    _ = @import("display/screen_snap.zig");
    _ = @import("extensions/addons.zig");
    _ = @import("frontier_elec.zig");
    _ = @import("display/items/items.zig");
    _ = @import("display/softmenus/softmenus.zig");
    _ = @import("display/display.zig");
    _ = @import("frontier_c47.zig");
    _ = @import("display/bufferize.zig");
    ...
    _ = @import("display/statusbar/status_bar.zig");
    _ = @import("display/text/char_string.zig");
