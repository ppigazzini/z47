...
const matrix_goto_grow = @import("matrix_editor/matrix_goto_grow.zig");
const matrix_lifecycle = @import("matrix_editor/matrix_lifecycle.zig");
const matrix_mim_add = @import("matrix_editor/matrix_mim_add.zig");
const matrix_mutation = @import("matrix_editor/matrix_mutation.zig");
const matrix_nav = @import("matrix_editor/matrix_nav.zig");
const matrix_mim_run = @import("matrix_editor/matrix_mim_run.zig");
const plot_regression = @import("plot/plot_regression.zig");
...
comptime {
    ...
    _ = @import("browsers/font_browser.zig");
    _ = @import("browsers/asn_browser.zig");
    _ = @import("extensions/textfiles.zig");
    _ = @import("extensions/xeqm.zig");
    _ = @import("frontier_screen.zig");
    _ = @import("frontier_screen_snap.zig");
    _ = @import("extensions/addons.zig");
    ...
    _ = @import("print/print.zig");
    _ = @import("frontier_config.zig");
    _ = @import("plot/plotstat.zig");
    _ = @import("matrix_editor/matrix_editor.zig");
    _ = @import("plot/graphs.zig");
    ...
    _ = @import("plot/graph_text.zig");
    _ = @import("frontier_timer.zig");
    _ = @import("extensions/radio_button_catalog.zig");
    _ = @import("frontier_debug.zig");
}
const printer_control = @import("print/printer_control.zig");
const runtime = @import("frontier_runtime.zig");
const plot_stat = @import("plot/plot_stat.zig");
const print_all_regs = @import("print/print_all_regs.zig");
const print_all_items = @import("print/print_all_items.zig");
const keys_management = @import("frontier_keys_management.zig");
const print_user = @import("print/print_user.zig");
