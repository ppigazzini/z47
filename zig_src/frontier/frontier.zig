...
const clear_all = @import("frontier_clear_all.zig");
const display_format = @import("frontier_display_format.zig");
const frontend_settings = @import("frontier_frontend_settings.zig");
const matrix_editor_entry = @import("frontier_matrix_editor_entry.zig");
const matrix_editor_refresh = @import("frontier_matrix_editor_refresh.zig");
const matrix_goto_grow = @import("frontier_matrix_goto_grow.zig");
const matrix_lifecycle = @import("frontier_matrix_lifecycle.zig");
const matrix_mim_add = @import("frontier_matrix_mim_add.zig");
const matrix_mutation = @import("frontier_matrix_mutation.zig");
const matrix_nav = @import("frontier_matrix_nav.zig");
const matrix_mim_run = @import("frontier_matrix_mim_run.zig");
const plot_regression = @import("frontier_plot_regression.zig");
const print_register = @import("frontier_print_register.zig");
const program_clear = @import("frontier_program_clear.zig");
const cauchy = @import("distributions/cauchy.zig");
const weibull = @import("distributions/weibull.zig");
const logistic = @import("distributions/logistic.zig");
const exponential = @import("distributions/exponential.zig");
const pareto = @import("distributions/pareto.zig");
const uniform = @import("distributions/uniform.zig");
const gev = @import("distributions/gev.zig");
const geometric = @import("distributions/geometric.zig");
const poisson = @import("distributions/poisson.zig");
const binomial = @import("distributions/binomial.zig");
const neg_binom = @import("distributions/neg_binom.zig");
const hyper = @import("distributions/hyper.zig");
const chi2 = @import("distributions/chi2.zig");
const normal = @import("distributions/normal.zig");
const f_dist = @import("distributions/f.zig");
const t_dist = @import("distributions/t.zig");
...
comptime {
    _ = @import("frontier_real_type.zig");
    ...
    _ = @import("frontier_date_time.zig");
    _ = @import("frontier_integers.zig");
    _ = @import("frontier_sort.zig");
    _ = @import("frontier_error.zig");
    _ = @import("frontier_lbl_gto_xeq.zig");
    _ = @import("frontier_string_funcs.zig");
    _ = @import("frontier_recall.zig");
    _ = @import("frontier_fractions.zig");
    _ = @import("frontier_store.zig");
    _ = @import("frontier_stats.zig");
    _ = @import("frontier_clcvar.zig");
    _ = @import("frontier_next_step.zig");
    _ = @import("frontier_decode.zig");
    _ = @import("frontier_curve_fitting.zig");
    _ = @import("frontier_input.zig");
    _ = @import("frontier_jm.zig");
    _ = @import("frontier_flag_browser.zig");
    _ = @import("frontier_calc_mode.zig");
    _ = @import("frontier_register_browser.zig");
    _ = @import("frontier_programmable_menu.zig");
    _ = @import("frontier_font_browser.zig");
    _ = @import("frontier_asn_browser.zig");
    _ = @import("frontier_textfiles.zig");
    _ = @import("frontier_xeqm.zig");
    _ = @import("frontier_screen.zig");
    _ = @import("frontier_screen_snap.zig");
    _ = @import("frontier_addons.zig");
    _ = @import("frontier_elec.zig");
    _ = @import("frontier_items.zig");
    _ = @import("frontier_softmenus.zig");
    _ = @import("frontier_display.zig");
    _ = @import("frontier_c47.zig");
    _ = @import("frontier_bufferize.zig");
    _ = @import("frontier_print.zig");
    _ = @import("frontier_config.zig");
    _ = @import("frontier_plotstat.zig");
    _ = @import("frontier_matrix_editor.zig");
    _ = @import("frontier_graphs.zig");
    _ = @import("frontier_manage.zig");
    _ = @import("frontier_tam.zig");
    _ = @import("frontier_assign.zig");
    _ = @import("frontier_status_bar.zig");
    _ = @import("frontier_char_string.zig");
    _ = @import("frontier_graph_text.zig");
    _ = @import("frontier_timer.zig");
    _ = @import("frontier_radio_button_catalog.zig");
    _ = @import("frontier_debug.zig");
}
const printer_control = @import("frontier_printer_control.zig");
const runtime = @import("frontier_runtime.zig");
const plot_stat = @import("frontier_plot_stat.zig");
const print_all_regs = @import("frontier_print_all_regs.zig");
