...
const cauchy = @import("frontier_cauchy.zig");
const weibull = @import("frontier_weibull.zig");
const logistic = @import("frontier_logistic.zig");
const exponential = @import("frontier_exponential.zig");
const pareto = @import("frontier_pareto.zig");
const uniform = @import("frontier_uniform.zig");
const gev = @import("frontier_gev.zig");
const geometric = @import("frontier_geometric.zig");
const poisson = @import("frontier_poisson.zig");
const binomial = @import("frontier_binomial.zig");
const neg_binom = @import("frontier_neg_binom.zig");
const hyper = @import("frontier_hyper.zig");
const chi2 = @import("frontier_chi2.zig");
const normal = @import("frontier_normal.zig");
const f_dist = @import("frontier_f.zig");
const t_dist = @import("frontier_t.zig");
...
comptime {
    ...
    _ = @import("frontier_martel_fonts.zig");
