...
const const_1024 = constR(5464);
const const_60 = constR(5368);
const const_3600 = constR(5520);
const const_86400 = constR(5596);
const const_100 = constR(7604);
const const_24 = constR(5240);
const const_12 = constR(5216);
const const39_ln2 = constR(4700);
const const39_root2 = constR(4736);
const const39_pi = constR(1848);
const const39_eE = constR(176);
const const39_PHI = constR(1596);
const const39_rt3 = constR(5792);
const const39_rt5 = constR(5828);
const const39_rt7 = constR(5864);
const const39_rtpi = constR(5924);
const const39_1onpi = constR(5960);
const const39_1oneE = constR(4460);
const const39_pisq = constR(5996);
const const39_eEsq = constR(6032);
const const39_1onpisq = constR(6068);
const const39_1oneEsq = constR(6104);
const const_plusInfinity = constR(1696);
const const_minusInfinity = constR(1684);
const const_1e_24 = constR(4544);
const const34_1e_24 = constR34(16320);
const const34_2p32 = constR34(16960);
