...
// to program_clear.run in frontier_program_clear_owned.zig). So here fnClPAll is a
...
// frontier.zig (delegating to frontier_program_clear_owned.zig, a faithful copy of
