...
const NUMBER_OF_GLYPH_ROWS = 259; // defines.h: 259. This sizes the exported glyphRow[] global that C declares as glyphRow[259]; 242 under-allocated it.
