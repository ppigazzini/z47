...
comptime {
    ...
    _ = @import("convert/conversion_units.zig");
    _ = @import("convert/conversion_angles.zig");
    _ = @import("register_value_conversions.zig");
    _ = @import("convert/date_time.zig");
    _ = @import("convert/integers.zig");
    _ = @import("display/sort.zig");
    _ = @import("error.zig");
    _ = @import("program/lbl_gto_xeq.zig");
    _ = @import("display/text/string_funcs.zig");
    _ = @import("recall.zig");
    _ = @import("convert/fractions.zig");
    _ = @import("store.zig");
    _ = @import("stats.zig");
    _ = @import("program/clcvar.zig");
    _ = @import("program/next_step.zig");
    ...
    _ = @import("program/programmable_menu.zig");
    ...
    _ = @import("program/manage.zig");
    _ = @import("input/tam.zig");
    _ = @import("input/assign.zig");
