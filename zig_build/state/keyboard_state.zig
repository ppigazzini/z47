...
pub fn addHostRuntimeObjectsWithOptions(
    ...
    const object = addRuntimeObjectWithIncludeDir(b, target, optimize, name_prefix, b.path("zig_src/kernel/keyboard_state.zig"), options);
...
pub fn addParityExecutable(
    ...
    runtime_object.root_module.addImport("z47_keyboard_state_shared", b.createModule(.{
        .root_source_file = b.path("zig_src/kernel/keyboard_state_shared.zig"),
        .target = target,
        .optimize = optimize,
    }));
