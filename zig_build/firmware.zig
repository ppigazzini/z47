...
pub fn registerSteps(
    ...
    }, context.core_sources, context.version_headers_dir, context.generated, arm_gmp_dmcp, dmcp_shortint_leaf_objects, dmcp_stack_state_objects, forcecrc32, decnumber_fastmul);
    ...
    const dmcp5 = addFirmwareBuild(b, .{
        ...
        .generated_qspi_header_name = "generated_qspi_crc.h",
        .qspi_macro = "USE_GEN_QSPI_CRC",
    }, context.core_sources, context.version_headers_dir, context.generated, arm_gmp_dmcp5, dmcp5_shortint_leaf_objects, dmcp5_stack_state_objects, forcecrc32, decnumber_fastmul);
...
fn addFirmwareBuild(
    ...
    const pre_build = addFirmwareElfBuild(b, config, .pre, core_sources, version_headers_dir, generated, arm_gmp, shortint_leaf_objects, stack_state_objects, decnumber_fastmul, null);
    ...
    const final_build = addFirmwareElfBuild(b, config, .final, core_sources, version_headers_dir, generated, arm_gmp, shortint_leaf_objects, stack_state_objects, decnumber_fastmul, generated_qspi_header.path);
