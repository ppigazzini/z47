...
alignas(4) unsigned char ctxtReal34[28];
alignas(4) unsigned char ctxtReal75[28];
...
alignas(4) unsigned char firstGregorianDay[4];
...
alignas(2) unsigned char lastCenturyHighUsed[2];
alignas(4) unsigned char lastDenominator[4];
