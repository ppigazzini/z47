#!/usr/bin/env bash
#
# Idiom ratchet: fail if any transliteration anti-pattern in
...
#
# Wired blocking into CI: the idiom-ratchet-guard job in
...
# The integer-narrowing ceiling on the untrusted-file load path. Kept a
