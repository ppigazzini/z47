...
/*083*/  generateConstantArray("pi",            "+3.141592653589793238462643383279502884197169399375105821e+00"); cc++;
  ...
  generateConstantArray("ErgToJ",        "+1.000000000000000000000000000000000000000000000000000000e+07"); // joule  = 10^-7
  generateConstantArray("FoeToJ",        "+1.000000000000000000000000000000000000000000000000000000e-44"); // joule  = 10^44
...
//// Chef menu
  ...
  generateConstantArray("InchToCm",      "+2.540000000000000000000000000000000000000000000000000000e+00"); // cm     = inch × 0.0254 × 1000 / 10
