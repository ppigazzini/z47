...
void generateConstant(char *name, int32_t digits, bool_t exact, char *value) {
  ...
  if(exact) {
    ...
    sprintf(temp, "const%" PRId32 "_", digits);
  }

  lenInBytes = 10 + sizeof(decNumberUnit) * ((digits+DECDPUN-1)/DECDPUN);
...
void generateAllConstants(void) {
  ...
  cc = 0;
/*000*/  generateConstant("a",              7, EXACT,  "+365.2425"                                                    ); cc++; // per definition
/*001*/  generateConstant("a0",            12, EXACT,  "+5.29177210544e-11"                                           ); cc++; // a_0 = 5.29177210544(82)E−11 m, CODATA 2022
/*002*/  generateConstant("aMoon",          4, EXACT,  "+384.4e+6"                                                    ); cc++;
/*003*/  generateConstant("aEarth",         7, EXACT,  "+149.5979e+9"                                                 ); cc++;
/*004*/  generateConstant("c",              9, EXACT,  "+299792458"                                                   ); cc++; // c = 299792458 m/s, exact per definition, SI 2019 (NIST.SP.330-2019)
/*005*/  generateConstant("c1",            39, APPROX, "+3.741771852192758011367155555929985138219953097124061418e-16"); cc++;
/*006*/  generateConstant("c2",            39, APPROX, "+1.438776877503933802146671601543911595199069423148099191e-02"); cc++;
/*007*/  generateConstant("e",             10, EXACT,  "+1.602176634e-19"                                             ); cc++; // e = 1.602176634E−19 C, exact per definition, CODATA 2017, SI 2019 (NIST.SP.330-2019)
/*008*/  generateConstant("eE",            39, APPROX, "+2.718281828459045235360287471352662497757247093699959575"    ); cc++; // math constant e
/*009*/  generateConstant("F",             18, EXACT,  "+96485.3321233100184"                                         ); cc++;
/*010*/  generateConstant("Falpha",        39, APPROX, "+2.502907875095892822283902873218215786381271376727149977"    ); cc++; // math constant Falpha
/*011*/  generateConstant("Fdelta",        39, APPROX, "+4.669201609102990671853203820466201617258185577475768633"    ); cc++; // math constant Fdelta
/*012*/  generateConstant("G",              5, EXACT,  "+6.6743e-11"                                                  ); cc++;
/*013*/  generateConstant("G0",            39, APPROX, "+7.748091729863650646680823323308763943587286047673370920e-05"); cc++;
/*014*/  generateConstant("GC",            39, APPROX, "+9.159655941772190150546035149323841107741493742816721343e-01"); cc++; // math constant Catalan
/*015*/  generateConstant("ge",            15, EXACT,  "-2.00231930436092"                                            ); cc++; // g_e− = −2.00231930436092(36), CODATA 2022
/*016*/  generateConstant("GM",            10, EXACT,  "+3.986004418e+14"                                             ); cc++;
/*017*/  generateConstant("gEarth",         6, EXACT,  "+9.80665"                                                     ); cc++; // per definition
/*018*/  generateConstant("Planck",         9, EXACT,  "+6.62607015e-34"                                              ); cc++; // h = 6.62607015E−34 J⋅s, exact per definition, CODATA 2017, SI 2019 (NIST.SP.330-2019)
/*019*/  generateConstant("PlanckOn2pi",   39, APPROX, "+1.054571817646156391262428003302280744722826330020413122e-34"); cc++;
/*020*/  generateConstant("k",              7, EXACT,  "+1.380649e-23"                                                ); cc++; // k = 1.380649E−23 J/K, exact per definition, CODATA 2017, SI 2019 (NIST.SP.330-2019)
/*021*/  generateConstant("KJ",            39, APPROX, "+4.835978484169836324476582850545281353533511866004014461e+14"); cc++;
/*022*/  generateConstant("lPL",            7, EXACT,  "+1.616255e-35"                                                ); cc++; // l_P = 1.616255(18)E−35 m, CODATA 2022
/*023*/  generateConstant("me",            11, EXACT,  "+9.1093837139e-31"                                            ); cc++; // m_e = 9.1093837139(28)E−31 kg, CODATA 2022
/*024*/  generateConstant("MMoon",          4, EXACT,  "+7.349e+22"                                                   ); cc++;
/*025*/  generateConstant("mn",            12, EXACT,  "+1.67492750056e-27"                                           ); cc++; // m_n = 1.67492750056(85)E−27 kg, CODATA 2022
/*026*/  generateConstant("mnOnmp",        12, EXACT,  "+1.00137841946"                                               ); cc++; // m_n/m_p = 1.00137841946(40), CODATA 2022
/*027*/  generateConstant("mp",            12, EXACT,  "+1.67262192595e-27"                                           ); cc++; // m_p = 1.67262192595(52)E−27 kg, CODATA 2022
/*028*/  generateConstant("mPL",            7, EXACT,  "+2.176434e-08"                                                ); cc++; // m_P = 2.176434(24)E−8 kg, CODATA 2022
/*029*/  generateConstant("mpOnme",        13, EXACT,  "+1836.152673426"                                              ); cc++; // m_p/⁠m_e = 1836.152673426(32), CODATA 2022
/*030*/  generateConstant("mu",            12, EXACT,  "+1.66053906892e-27"                                           ); cc++; // mu = 1.66053906892(52)E−27 kg, CODATA 2022
/*031*/  generateConstant("muc2",          12, EXACT,  "+1.49241808768e-10"                                           ); cc++; // muc2 = 1.49241808768(46)E−10 J, CODATA 2022
/*032*/  generateConstant("mmu",           10, EXACT,  "+1.883531627e-28"                                             ); cc++; // m_μ = 1.883531627(42)E−28 kg, CODATA 2022
/*033*/  generateConstant("mSun",           5, EXACT,  "+1.9891e+30"                                                  ); cc++;
/*034*/  generateConstant("mEarth",         5, EXACT,  "+5.9736e+24"                                                  ); cc++;
/*035*/  generateConstant("NA",             9, EXACT,  "+6.02214076e+23"                                              ); cc++; // N_A = 6.02214076E23 1/mol, exact per definition, CODATA 2017, SI 2019 (NIST.SP.330-2019)
/*036*/  generateConstant("NaN",            1, EXACT,  "Not a number"                                                 ); cc++;
/*037*/  generateConstant("p0",             6, EXACT,  "+101325"                                                      ); cc++; // per definition
/*038*/  generateConstant("R",             15, EXACT,  "+8.31446261815324"                                            ); cc++;
/*039*/  generateConstant("re",            11, EXACT,  "+2.8179403205e-15"                                            ); cc++; // r_e = 2.8179403205(13)E−15 m, CODATA 2022
/*040*/  generateConstant("RK",            39, APPROX, "+25812.80745930450666004551670608744304245727322140342177"    ); cc++;
/*041*/  generateConstant("RMoon",          6, EXACT,  "+1.73753e+06"                                                 ); cc++;
/*042*/  generateConstant("RInfinity",     14, EXACT,  "+10973731.568157"                                             ); cc++; // R_∞ = 10973731.568157(12) 1/m, CODATA 2022
/*043*/  generateConstant("RSun",           3, EXACT,  "+6.96e+08"                                                    ); cc++;
/*044*/  generateConstant("REarth",         6, EXACT,  "+6.37101e+06"                                                 ); cc++;
/*045*/  generateConstant("Sa",            39, EXACT,  "+6378137"                                                     ); cc++; // per definition
/*046*/  generateConstant("Sb",            11, EXACT,  "+6356752.3142"                                                ); cc++;
/*047*/  generateConstant("Se2",           12, EXACT,  "+6.69437999014e-03"                                           ); cc++;
/*048*/  generateConstant("Sep2",          12, EXACT,  "+6.73949674228e-03"                                           ); cc++;
/*049*/  generateConstant("Sfm1",          12, EXACT,  "+298.257223563"                                               ); cc++; // per definition
/*050*/  generateConstant("T0",             5, EXACT,  "+273.15"                                                      ); cc++; // per definition
/*051*/  generateConstant("TP",             7, EXACT,  "+1.416784e+32"                                                ); cc++; // T_P = 1.416784(16)E32 K, CODATA 2022
/*052*/  generateConstant("tPL",            7, EXACT,  "+5.391247e-44"                                                ); cc++; // t_P = 5.391247(60)×10−44 s, CODATA 2022
/*053*/  generateConstant("Vm",            39, APPROX, "+2.241396954501413773501110288675055514433752775721687639e-02"); cc++;
/*054*/  generateConstant("Z0",            12, EXACT,  "+3.76730313412e+02"                                           ); cc++; // Z0 = 376.730313412(59) Ω, CODATA 2022
/*055*/  generateConstant("alpha",         11, EXACT,  "+7.2973525643e-03"                                            ); cc++; // α = 0.0072973525643(11), CODATA 2022
/*056*/  generateConstant("K0",            39, APPROX, "+2.685452001065306445309714835481795693820382293994462953"    ); cc++; // math constant Khinchin
/*057*/  generateConstant("gammaEM",       39, APPROX, "+5.772156649015328606065120900824024310421593359399235988e-01"); cc++; // math constant Euler-Mascheroni
/*058*/  generateConstant("gammap",        11, EXACT,  "+2.6752218708e+08"                                            ); cc++; // γ_p = 2.6752218708(11)E8 1/(s⋅T), CODATA 2022
/*059*/  generateConstant("DELTAvcs",       9, EXACT,  "+9.19263177e+09"                                              ); cc++; // Δν(133Cs)hfs = 9192631770 Hz, exact per definition, SI 2019 (NIST.SP.330-2019)
/*060*/  generateConstant("epsilon0",      11, EXACT,  "+8.8541878188e-12"                                            ); cc++; // ε_0 = 8.8541878188(14)E−12 F/m, CODATA 2022
/*061*/  generateConstant("lambdaC",       12, EXACT,  "+2.42631023538e-12"                                           ); cc++; // λ_C = 2.42631023538(76)E−12 m, CODATA 2022
/*062*/  generateConstant("lambdaCn",      12, EXACT,  "+1.31959090382e-15"                                           ); cc++; // λ_C,n = 1.31959090382(67)E-15 m, CODATA 2022
/*063*/  generateConstant("lambdaCp",      11, EXACT,  "+1.3214098536e-15"                                            ); cc++; // λ_C,p = 1.32140985360(41)E-15
/*064*/  generateConstant("mu0",           12, EXACT,  "+1.25663706127e-06"                                           ); cc++; // μ_0 = 1.25663706127(20)E−6 N/A^2, CODATA 2022
/*065*/  generateConstant("muB",           11, EXACT,  "+9.2740100657e-24"                                            ); cc++; // μ_B = 9.2740100657(29)E-24 J/T, CODATA 2022
/*066*/  generateConstant("mue",           11, EXACT,  "-9.2847646917e-24"                                            ); cc++; // μ_e = -9.2847646917(29)E−24 J/T, CODATA 2022
/*067*/  generateConstant("mueOnmuB",      15, EXACT,  "-1.00115965218046"                                            ); cc++; // μ_e/⁠μ_B = -1.00115965218046(18), CODATA 2022
/*068*/  generateConstant("mun",            8, EXACT,  "-9.6623653e-27"                                               ); cc++; // μ_n = -9.6623653(23)E−27 J/T, CODATA 2022
/*069*/  generateConstant("mup",           12, EXACT,  "+1.41060679545e-26"                                           ); cc++; // μ_p = 1.41060679545(60)E−26 J/T, CODATA 2022
/*070*/  generateConstant("muu",           11, EXACT,  "+5.0507837393e-27"                                            ); cc++; // μ_N = 5.0507837393(16)E−27 J/T, CODATA 2022
/*071*/  generateConstant("mumu",           8, EXACT,  "-4.4904483e-26"                                               ); cc++; // μ_μ = -4.49044830(18)E−26 J/T, CODATA 2022
/*072*/  generateConstant("sigmaB",        39, APPROX, "+5.670374419184429453970996731889230875840122970291303682e-08"); cc++;
/*073*/  generateConstant("PHI",           39, APPROX, "+1.618033988749894848204586834365638117720309179805762862"    ); cc++; // math constant phi = (1 + sqrt(5)) / 2
/*074*/  generateConstant("PHI0",          39, APPROX, "+2.067833848461929323081115412147497340171545654934323552e-15"); cc++;
/*075*/  generateConstant("omega",          7, EXACT,  "+7.292115e-05"                                                ); cc++;
/*076*/  generateConstant("minusInfinity",  1, EXACT,  "-9e+9999"                                                     ); cc++; // math "constant"
/*077*/  generateConstant("plusInfinity",   1, EXACT,  "+9e+9999"                                                     ); cc++; // math "constant"
/*078*/  generateConstant("0",              1, EXACT,  "0"                                                            ); cc++;
/*079*/  generateConstant("BB",            39, APPROX, "+3.566668367128895828373073810012662699038701534076244140e-01"); cc++; //  solution to equation 1.2 in https://arxiv.org/pdf/2309.05050.pdf : sqrt(36x+3) / 4 + sin(2 pi sqrt(12x+1) / 3) = 0
/*080*/  generateConstant("DeltaS",        39, APPROX, "+2.414213562373095048801688724209698078569671875376948073"    ); cc++; //  1+√2
/*081*/  generateConstant("movSofa",       15, EXACT,  "+2.21953166887197"                                            ); cc++; //  https://mathworld.wolfram.com/MovingSofaProblem.html. The moving sofa number is the result of a lot of equation solving
/*082*/  generateConstant("tau",           39, APPROX, "+6.283185307179586476925286766559005768394338798750211642"    ); cc++; //  circle constant
/*083*/  generateConstant("pi",            39, APPROX, "+3.141592653589793238462643383279502884197169399375105821"    ); cc++;
  ...
  generateConstant("RpmRadps",      39, APPROX, "+1.047197551196597746154214461093167628065723133125035274e-01"); // Radps    =  Rpm  * 0.1047   // pi/30
  generateConstant("DegRad",        39, APPROX, "+1.745329251994329576923690768488612713442871888541725456e-02"); // Rad      =  Deg  * pi / 180
  generateConstant("DegGrad",       39, APPROX, "+1.111111111111111111111111111111111111111111111111111111    "); // Grad     =  Deg  * 10 / 9
  generateConstant("GradRad",       39, APPROX, "+1.570796326794896619231321691639751442098584699687552910e-02"); // Rad      =  Grad * pi / 200
...
//// Chef menu
  ...
  generateConstant("180onPi",       39, APPROX, "+5.729577951308232087679815481410517033240547246656432155e+01");
  generateConstant("60",             1, EXACT,  "+60"                                                          );
  generateConstant("200onPi",       39, APPROX, "+6.366197723675813430755350534900574481378385829618257950e+01");
  ...
  generateConstant34("_4712",       "-4.71200000000000000000000000000000000e+03");
  generateConstant34("0",           "+0.00000000000000000000000000000000000e+00");
  generateConstant34("1e_32",       "+1.00000000000000000000000000000000000e-32");
  generateConstant34("1e_24",       "+1.00000000000000000000000000000000000e-24");
  generateConstant34("1e_4",        "+1.00000000000000000000000000000000000e-04");
  generateConstant34("1on10",       "+1.00000000000000000000000000000000000e-01");
  generateConstant34("1on2",        "+5.00000000000000000000000000000000000e-01");
  generateConstant34("1",           "+1.00000000000000000000000000000000000e+00");
  generateConstant34("2",           "+2.00000000000000000000000000000000000e+00");
  generateConstant34("3",           "+3.00000000000000000000000000000000000e+00");
  generateConstant34("4",           "+4.00000000000000000000000000000000000e+00");
  generateConstant34("5",           "+5.00000000000000000000000000000000000e+00");
  generateConstant34("7",           "+7.00000000000000000000000000000000000e+00");
  generateConstant34("9",           "+9.00000000000000000000000000000000000e+00");
  generateConstant34("10",          "+1.00000000000000000000000000000000000e+01");
  generateConstant34("12",          "+1.20000000000000000000000000000000000e+01");
  generateConstant34("14",          "+1.40000000000000000000000000000000000e+01");
  generateConstant34("24",          "+2.40000000000000000000000000000000000e+01");
  generateConstant34("28",          "+2.80000000000000000000000000000000000e+01");
  generateConstant34("31",          "+3.10000000000000000000000000000000000e+01");
  generateConstant34("38",          "+3.80000000000000000000000000000000000e+01");
  generateConstant34("60",          "+6.00000000000000000000000000000000000e+01");
  generateConstant34("100",         "+1.00000000000000000000000000000000000e+02");
  generateConstant34("153",         "+1.53000000000000000000000000000000000e+02");
  generateConstant34("275",         "+2.75000000000000000000000000000000000e+02");
  generateConstant34("367",         "+3.67000000000000000000000000000000000e+02");
  generateConstant34("400",         "+4.00000000000000000000000000000000000e+02");
  generateConstant34("1000",        "+1.00000000000000000000000000000000000e+03");
  generateConstant34("1401",        "+1.40100000000000000000000000000000000e+03");
  generateConstant34("1461",        "+1.46100000000000000000000000000000000e+03");
  generateConstant34("3600",        "+3.60000000000000000000000000000000000e+03");
  generateConstant34("4716",        "+4.71600000000000000000000000000000000e+03");
  generateConstant34("4800",        "+4.80000000000000000000000000000000000e+03");
  generateConstant34("4900",        "+4.90000000000000000000000000000000000e+03");
  generateConstant34("5001",        "+5.00100000000000000000000000000000000e+03");
  generateConstant34("32075",       "+3.20750000000000000000000000000000000e+04");
  generateConstant34("43200",       "+4.32000000000000000000000000000000000e+04");
  generateConstant34("65535",       "+6.55350000000000000000000000000000000e+04");
  generateConstant34("86400",       "+8.64000000000000000000000000000000000e+04");
  generateConstant34("146097",      "+1.46097000000000000000000000000000000e+05");
  generateConstant34("274277",      "+2.74277000000000000000000000000000000e+05");
  generateConstant34("1e6",         "+1.00000000000000000000000000000000000e+06");
  generateConstant34("1729777",     "+1.72977700000000000000000000000000000e+06");
  generateConstant34("2p32",        "+4.29496729600000000000000000000000000e+09");
  generateConstant34("maxDate",     "+3.15569534869962720000000000000000000e+18");
  generateConstant34("maxTime",     "+3.60000000000000000000000000000000000e+19");
