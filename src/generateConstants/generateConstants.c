...
void generateAllConstants(void) {
  ...
  generateConstantArray("BB",            "+3.566668367128895828373073810012662699038701534076244140e+00"); c++;   //  solution to equation 1.2 in https://arxiv.org/pdf/2309.05050.pdf : sqrt(36x+3) / 4 + sin(2 pi sqrt(12x+1) / 3) = 0
