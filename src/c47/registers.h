 ...
 */
  ...
  #define REGISTER_STRING_DATA(a)                                ((char                 *)(getRegisterDataPointer(a) + sizeof(dataBlock_t))) // Memory pointer to the string of a register
  ...
  #define REGISTER_LONG_INTEGER_DATA(a)                          ((uint8_t              *)(getRegisterDataPointer(a) + sizeof(dataBlock_t))) // Memory pointer to the long integer of a register
