...
bool_t checkForAndChange        (char *displayString, const real34_t *val, const real_t *constant, const real_t *toleranceR, const char *constantStr,  bool_t frontSpace, bool_t isComplex);
