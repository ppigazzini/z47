...
TO_QSPI const nstr2 xeqTexts[] = { 
   //Create a 3x3 A-matrix
      { "XEQC47 RECT 3 ENTER 3 M.NEW STO 99 DROPX INDEX 99 1 ENTER 1 STOIJ DROPX DROPX" },
   ...
   //Create a 3x1 matrix from Z Y X
      { "XEQC47 3 ENTER 1 M.NEW STO 99 DROPX INDEX 99 3 ENTER 1 STOIJ DROPX DROPX STOEL DROPX  I- STOEL DROPX  I-  STOEL DROPX RCL 99 " },
   //Create a ZYX form a 3x1 matrix
      { "XEQC47 STO 99 INDEX 99 DROPX 1 ENTER 1 STOIJ DROPX DROPX RCLEL I+ RCLEL I+ RCLEL " }
    };
