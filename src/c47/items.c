...
/* 1381 */  { fnIntegrate,                  TM_LABEL,                    STD_INTEGRAL "f" STD_SPACE_4_PER_EM "dx",      STD_INTEGRAL "f" STD_SPACE_4_PER_EM "dx",      (0 << TAM_MAX_BITS) |     0, CAT_MENU | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
...
/* 1690 */  { fnIntegrateYX,                TM_REGISTER,                 STD_INTEGRAL STD_SUB_y STD_SUP_x "fdxA",       STD_INTEGRAL  STD_SUB_y STD_SUP_x "fdxA",      (0 << TAM_MAX_BITS) |    99, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_REGISTER     },
...
/* 1700 */  { fnIntegrate,                  TM_REGISTER,                 STD_INTEGRAL "fdxA",                           STD_INTEGRAL "fdxA",                           (0 << TAM_MAX_BITS) |    99, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_REGISTER     },
...
/* 2368 */  { itemToBeCoded,                EQ_REALSOLVE,                "realSlv",                                     "realSlv",                                     (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2369 */  { fnEqSolvGraph,                EQ_REALSOLVE_LU,             "realSlv" STD_SERIAL_IO,                       "realSlv" STD_SERIAL_IO,                       (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2370 */  { fnEqSolvGraph,                EQ_CPXSOLVE,                 "cpxSlv",                                      "cpxSlv",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2371 */  { itemToBeCoded,                EQ_CPXSOLVE_LU,              "cpxSlv" STD_SERIAL_IO,                        "cpxSlv" STD_SERIAL_IO,                        (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2372 */  { fnEqSolvGraph,                EQ_PLOT,                     "DrawYX",                                      "DrawYX",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_NONE         },
/* 2373 */  { fnEqSolvGraph,                EQ_PLOT_LU,                  "DrawX" STD_SERIAL_IO,                         "DrawX" STD_SERIAL_IO,                         (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_NONE         },
