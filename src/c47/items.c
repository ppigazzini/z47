...
/* 1956 */  { fnRlc_1,                      NOPARAM,                     "RLC1",                                        "RLC1",                                        (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         | HG_ENABLED         },//JM SHOI
/* 1957 */  { fnRrc_1,                      NOPARAM,                     "RRC1",                                        "RRC1",                                        (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         | HG_ENABLED         },//JM SHOI
