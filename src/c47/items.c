...
/* 1461 */  { fnEuclideanNorm,              NOPARAM,                     "||" SEP "x" SEP "||" STD_SUB_2,               "||" SEP "x" SEP "||" STD_SUB_2,               (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         | HG_ENABLED         },
...
/* 1574 */  { fnRowNorm,                    NOPARAM,                     "||" SEP "x" SEP "||" STD_SUB_INFINITY,        "||" SEP "x" SEP "||" STD_SUB_INFINITY,        (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         | HG_ENABLED         },
...
/* 2667 */  { itemToBeCoded,                 NOPARAM,                     "",                                     "Last item",                                         (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     | HG_ENABLED         },
