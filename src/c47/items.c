...
/* 1417 */  { fnBnStar,                     NOPARAM,                     "B" STD_B_ast_n STD_EQUALS_SH STD_SPACE_4_PER_EM "|B" STD_SUB_2 STD_SUB_n "|", "B" STD_B_ast_n STD_EQUALS_SH STD_SPACE_4_PER_EM "|B" STD_SUB_2 STD_SUB_n "|", (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_ENABLED  | PTP_NONE         | HG_ENABLED         },
...
/* 1479 */  { fnInvGd,                      NOPARAM,                     "g" STD_G_d_min1,                              "g" STD_G_d_min1,                              (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_ENABLED  | PTP_NONE         | HG_ENABLED         },
...
/* 1506 */  { fnLaguerreAlpha,              NOPARAM,                     "L" STD_L_ma,                                  "L" STD_L_ma,                                  (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_ENABLED  | PTP_NONE         | HG_ENABLED         },
...
/* 2412 */  { fnEvPFacts,                   M_SIGMA_p1,                  STD_sigma STD_S_1_ast,                         STD_sigma STD_S_1_ast,                         (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         | HG_ENABLED         },
/* 2413 */  { fnEvPFacts,                   M_SIGMA_pk,                  STD_sigma STD_S_k_ast,                         STD_sigma STD_S_k_ast,                         (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         | HG_ENABLED         },
