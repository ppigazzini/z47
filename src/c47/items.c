...
*/
    ...
    else if(((FIRST_CONSTANT <= func && func <= LAST_CONSTANT) || func == ITM_CNST) && calcMode == CM_NORMAL) {   //including ITM_CNST inside the range (historically)
      temporaryInformation = TI_LAST_CONST_CATNAME;
    }
    else if(calcMode == CM_NORMAL && !getSystemFlag(FLAG_INTING) && !getSystemFlag(FLAG_SOLVING)) {
...
/*  480 */  { fnGetSystemFlag,                 FLAG_AMORT_HP12C,            "HP12C",                                       "HP12C",                                       (0 << TAM_MAX_BITS) |     0, CAT_SYFL | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     | HG_ENABLED         },
...
/* 1584 */  { fnJacobiAmplitude,               NOPARAM,                     "am(u,m)",                                     "am(u,m)",                                     (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         | HG_ENABLED         | RESULT_IN_X },
...
/* 1709 */  { itemToBeCoded,                   NOPARAM,                     ">" STD_PRINTER "CHAR<",                       ">" STD_PRINTER "CHAR<",                       (0 << TAM_MAX_BITS) |   127, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NUMBER_8     | HG_ENABLED         },
...
/* 1717 */  { itemToBeCoded,                   NOPARAM,                     ">" STD_PRINTER "TAB<",                        ">" STD_PRINTER "TAB<",                        (0 << TAM_MAX_BITS) |   127, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NUMBER_8     | HG_ENABLED         },
...
/* 1721 */  { itemToBeCoded,                   NOPARAM,                     ">" STD_PRINTER "#<",                           ">" STD_PRINTER "#<",                         (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         | HG_ENABLED         },
...
/* 2699 */  { fnP_PrintAllItems,               NOPARAM,                     STD_PRINTER "ITEMS",                           STD_PRINTER "ITEMS",                           (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     | HG_ENABLED         },
...
/* 2721 */  { fnAmortNext,                  NOPARAM,                        "NXTPER",                                      "NEXT",                                        (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     | HG_ENABLED         },
