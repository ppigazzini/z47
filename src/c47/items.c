...
/* 2104 */  { fnKtoM,                       NOPARAM,                     "k" STD_RIGHT_ARROW "m",                       "k" STD_RIGHT_ARROW "m",                       (0 << TAM_MAX_BITS) |     0, CAT_MENU | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         | HG_ENABLED         },
/* 2105 */  { fnMtoK,                       NOPARAM,                     "m" STD_RIGHT_ARROW "k",                       "m" STD_RIGHT_ARROW "k",                       (0 << TAM_MAX_BITS) |     0, CAT_MENU | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         | HG_ENABLED         },
...
/* 2395 */  { fnEllipse,                    NOPARAM,                     "a,b" STD_RIGHT_ARROW "k",                     "a,b" STD_RIGHT_ARROW "k",                     (0 << TAM_MAX_BITS) |     0, CAT_MENU | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         | HG_ENABLED         },
