...
/* 1844 */  { fnSetCountDownTimerApp,       TM_REGISTER,                 "RCL" STD_HOURGLASS_WH,                        "RCL" STD_HOURGLASS_WH,                        (0 << TAM_MAX_BITS) |    99, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
