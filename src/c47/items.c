...
/*  356 */  UNIT_CONV(constFactorQuartL,    multiply,   "qt." STD_UK STD_RIGHT_ARROW "l",                   "qt." STD_UK STD_RIGHT_ARROW "l"),
/*  357 */  UNIT_CONV(constFactorQuartL,      divide,   "l" STD_RIGHT_ARROW "qt." STD_UK,                   "l" STD_RIGHT_ARROW "qt." STD_UK),
