...
/* 1593 */  { configCommon,                 CFG_EUROPE,                  "SETEUR",                                      "EUROP",                                       (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         | HG_ENABLED         },
...
/* 1596 */  { configCommon,                 CFG_DFLT,                    "SETDFLT",                                     "DEFLT",                                       (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         | HG_ENABLED         },
...
/* 2553 */  { fnPseudoMenu,                 (2<<14) + MNU_BITS,          "BITS" STD_CR "2",                             "BITS" STD_CR "2",                             (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     | HG_ENABLED         },
