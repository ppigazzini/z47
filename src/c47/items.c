...
/* 2368 */  { itemToBeCoded,                EQ_REALSOLVE,                "realSlv" STD_YX,                              "realSlv" STD_YX,                              (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2369 */  { fnEqSolvGraph,                EQ_REALSOLVE_LU,             "realSlv",                                     "realSlv",                                     (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2370 */  { fnEqSolvGraph,                EQ_CPXSOLVE,                 "cpxSlv" STD_YX,                               "cpxSlv" STD_YX,                               (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2371 */  { itemToBeCoded,                EQ_CPXSOLVE_LU,              "cpxSlv",                                      "cpxSlv",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
