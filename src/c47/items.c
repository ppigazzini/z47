...
/* 1287 */  { fnParetoP,                    NOPARAM,                     "GPD" STD_SUB_p,                               "GPD" STD_SUB_p,                               (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 1288 */  { fnParetoL,                    NOPARAM,                     "GPD" STD_GAUSS_BLACK_L STD_GAUSS_WHITE_R,     "GPD" STD_GAUSS_BLACK_L STD_GAUSS_WHITE_R,     (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 1289 */  { fnParetoU,                    NOPARAM,                     "GPD" STD_GAUSS_WHITE_L STD_GAUSS_BLACK_R,     "GPD" STD_GAUSS_WHITE_L STD_GAUSS_BLACK_R,     (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 1290 */  { fnParetoI,                    NOPARAM,                     "GPD" STD_SUP_MINUS STD_SUP_1,                 "GPD" STD_SUP_MINUS STD_SUP_1,                 (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
...
/* 2329 */  { fnStore,                      REGISTER_R,                  "STO" STD_SUB_R " " STD_gamma,                 "STO" STD_SUB_R " " STD_gamma,                 (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
