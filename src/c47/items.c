...
/* 1690 */  { fnIntegrate,                  TM_REGISTER,                 STD_INTEGRAL STD_SUB_y STD_SUP_x,              STD_INTEGRAL  STD_SUB_y STD_SUP_x,             (0 << TAM_MAX_BITS) |    99, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_REGISTER     },
