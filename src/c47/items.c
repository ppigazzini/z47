...
/* 2288 */  { fnGetSystemFlag,              FLAG_3DPHYS ,                STD_v_BAR STD_SUB_3 "PHYS",                    STD_v_BAR STD_SUB_3 "PHYS",                    (0 << TAM_MAX_BITS) |     0, CAT_SYFL | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     | HG_ENABLED         },
/* 2289 */  { fnGetSystemFlag,              FLAG_3DXYZ  ,                STD_v_BAR STD_SUB_3 "xyz",                     STD_v_BAR STD_SUB_3 "xyz",                     (0 << TAM_MAX_BITS) |     0, CAT_SYFL | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     | HG_ENABLED         },
