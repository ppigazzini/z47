...
#define PERA_   "/" STD_a //STD_a_MACRON //  "/a"
...
/* 1771 */  { fnRecall,                     RESERVED_VARIABLE_NPPER,     STD_SUB_R STD_SPACE_3_PER_EM "NP" PER_,        STD_SUB_R STD_SPACE_3_PER_EM "NP" PER_,        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_DISABLED     },
