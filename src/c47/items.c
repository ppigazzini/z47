...
/* 1743 */  { fnMulModAngle,                NOPARAM,                     STD_CROSS "+MOD" STD_ANGLE,                    STD_CROSS "+MOD" STD_ANGLE,                    (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         | HG_ENABLED         },
