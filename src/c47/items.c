...
/* 1745 */  { fnVectorAngle,                NOPARAM,                     STD_MEASURED_ANGLE STD_SPACE_4_PER_EM STD_NOR "," STD_NOR, STD_MEASURED_ANGLE STD_SPACE_4_PER_EM STD_NOR "," STD_NOR, (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
...
/* 2472 */  { fnVectorDist,                 NOPARAM,                     "|" STD_NOR "-" STD_NOR "|",                   "|" STD_NOR "-" STD_NOR "|",                   (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2473 */  { itemToBeCoded,                NOPARAM,                     "M.CONCT",                                     "CONCAT",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2474 */  { fnConvertStkToMx,                   2,                     "zyx" STD_RIGHT_ARROW STD_NOR STD_SUB_3,       "zyx" STD_RIGHT_ARROW STD_NOR STD_SUB_3,       (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2475 */  { fnConvertStkToMx,                   6,                     "yx" STD_RIGHT_ARROW STD_NOR STD_SUB_2,        "yx" STD_RIGHT_ARROW STD_NOR STD_SUB_2,        (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2476 */  { fnConvertMxToStk,                   2,                     STD_NOR STD_SUB_3 STD_RIGHT_ARROW "zyx",       STD_NOR STD_SUB_3 STD_RIGHT_ARROW "zyx",       (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2477 */  { fnConvertMxToStk,                   6,                     STD_NOR STD_SUB_2 STD_RIGHT_ARROW "yx",        STD_NOR STD_SUB_2 STD_RIGHT_ARROW "yx",        (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2478 */  { fnConvertMxToStk,                0x62,                     STD_NOR STD_RIGHT_ARROW "..yx",                STD_NOR STD_RIGHT_ARROW "..yx",                (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2479 */  { fnConvertStkToMx,                   3,                     STD_NOR STD_SUB_3 "[100]",                     STD_NOR STD_SUB_3 "[100]",                     (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2480 */  { fnConvertStkToMx,                   4,                     STD_NOR STD_SUB_3 "[010]",                     STD_NOR STD_SUB_3 "[010]",                     (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2481 */  { fnConvertStkToMx,                   5,                     STD_NOR STD_SUB_3 "[001]",                     STD_NOR STD_SUB_3 "[001]",                     (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
