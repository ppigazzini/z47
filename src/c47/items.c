...
/* 2288 */  { fnGetSystemFlag,              FLAG_PRTEN,                  "PRTEN",                                       "PRTEN",                                       (0 << TAM_MAX_BITS) |     0, CAT_SYFL | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     | HG_ENABLED         },
...
/* 2643 */  { SetSetting,                   FLAG_TRACE,                  "TRACE",                                       "TRACE",                                       (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     | HG_ENABLED         },
/* 2644 */  { fnP_GetDelay,                 NOPARAM,                     STD_PRINTER "DLAY?",                           STD_PRINTER "DLAY?",                           (0 << TAM_MAX_BITS) |   127, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NUMBER_8     | HG_ENABLED         },
/* 2645 */  { fnP_PrinterOnOff,             PRON,                        STD_PRINTER "ON",                              STD_PRINTER "ON",                              (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         | HG_ENABLED         },
/* 2646 */  { fnP_PrinterOnOff,             PROFF,                       STD_PRINTER "OFF",                             STD_PRINTER "OFF",                             (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         | HG_ENABLED         },
