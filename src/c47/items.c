...
/* 1827 */  { itemToBeCoded,                NOPARAM,                     "op_A",                                        "[A]",                                         (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_NONE         },
...
/* 1931 */  { itemToBeCoded,                NOPARAM,                     "zyx" STD_RIGHT_ARROW "M",                     "zyx" STD_RIGHT_ARROW "M",                     (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_NONE         },
...
/* 2041 */  { itemToBeCoded,                NOPARAM,                     "M" STD_RIGHT_ARROW "zyx",                     "M" STD_RIGHT_ARROW "zyx",                     (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_NONE         },
...
/* NNNN */  UNIT_CONV(constFactorCupcFzus,      multiply,      "cup" STD_USc STD_RIGHT_ARROW "floz" STD_US,                          "cup" STD_USc STD_RIGHT_ARROW                              ),
/* NNNN */  UNIT_CONV(constFactorCupcMl,        multiply,      "cup" STD_USc STD_RIGHT_ARROW "m" STD_litre,                          "cup" STD_USc STD_RIGHT_ARROW                              ),
/* NNNN */  UNIT_CONV(constFactorCupukFzuk,     multiply,      "cup" STD_UK STD_RIGHT_ARROW "floz" STD_UK,                           "cup" STD_UK STD_RIGHT_ARROW                               ),
/* NNNN */  UNIT_CONV(constFactorCupukMl,       multiply,      "cup" STD_UK STD_RIGHT_ARROW "m" STD_litre,                           "cup" STD_UK STD_RIGHT_ARROW                               ),
...
/* NNNN */  UNIT_CONV(constFactorFzusCupc,        divide,      "floz" STD_US STD_RIGHT_ARROW "cup" STD_USc,                           "floz" STD_US STD_RIGHT_ARROW                             ),
/* NNNN */  UNIT_CONV(constFactorFzusTbspc,     multiply,      "floz" STD_US STD_RIGHT_ARROW "Tbsp" STD_USc,                         "floz" STD_US STD_RIGHT_ARROW                              ),
/* NNNN */  UNIT_CONV(constFactorFzusTspc,      multiply,      "floz" STD_US STD_RIGHT_ARROW "tsp" STD_USc,                           "floz" STD_US STD_RIGHT_ARROW                             ),
/* NNNN */  UNIT_CONV(constFactorMlCupc,          divide,      "m" STD_litre STD_RIGHT_ARROW "cup" STD_USc,                          "m" STD_litre STD_RIGHT_ARROW                              ),
/* NNNN */  UNIT_CONV(constFactorMlCupuk,         divide,      "m" STD_litre STD_RIGHT_ARROW "cup" STD_UK,                           "m" STD_litre STD_RIGHT_ARROW                              ),
/* NNNN */  UNIT_CONV(constFactorMlPintlq,        divide,      "m" STD_litre STD_RIGHT_ARROW "pint" STD_SUB_l STD_SUB_i STD_SUB_q,   "m" STD_litre STD_RIGHT_ARROW                              ),
/* NNNN */  UNIT_CONV(constFactorMlPintuk,        divide,      "m" STD_litre STD_RIGHT_ARROW "pint" STD_UK,                          "m" STD_litre STD_RIGHT_ARROW                              ),
/* NNNN */  UNIT_CONV(constFactorMlQt,            divide,      "m" STD_litre STD_RIGHT_ARROW "qt" STD_UK,                            "m" STD_litre STD_RIGHT_ARROW                              ),
/* NNNN */  UNIT_CONV(constFactorMlQtus,          divide,      "m" STD_litre STD_RIGHT_ARROW "qt" STD_US,                            "m" STD_litre STD_RIGHT_ARROW                              ),
/* NNNN */  UNIT_CONV(constFactorMlTbspc,         divide,      "m" STD_litre STD_RIGHT_ARROW "Tbsp" STD_USc,                         "m" STD_litre STD_RIGHT_ARROW                              ),
/* NNNN */  UNIT_CONV(constFactorMlTbspuk,        divide,      "m" STD_litre STD_RIGHT_ARROW "tbsp" STD_UK,                          "m" STD_litre STD_RIGHT_ARROW                              ),
/* NNNN */  UNIT_CONV(constFactorMlTspc,          divide,      "m" STD_litre STD_RIGHT_ARROW "tsp" STD_USc,                           "m" STD_litre STD_RIGHT_ARROW                             ),
/* NNNN */  UNIT_CONV(constFactorMlTspuk,         divide,      "m" STD_litre STD_RIGHT_ARROW "tsp" STD_UK,                           "m" STD_litre STD_RIGHT_ARROW                              ),
/* NNNN */  UNIT_CONV(constFactorPintlqMl,      multiply,      "pint" STD_SUB_l STD_SUB_i STD_SUB_q STD_RIGHT_ARROW "m" STD_litre,   "pint" STD_SUB_l STD_SUB_i STD_SUB_q STD_RIGHT_ARROW       ),
/* NNNN */  UNIT_CONV(constFactorPintukMl,      multiply,      "pint" STD_UK STD_RIGHT_ARROW "m" STD_litre,                          "pint" STD_UK STD_RIGHT_ARROW                              ),
/* NNNN */  UNIT_CONV(constFactorQtMl,          multiply,      "qt" STD_UK STD_RIGHT_ARROW "m" STD_litre,                            "qt" STD_UK STD_RIGHT_ARROW                                ),
/* NNNN */  UNIT_CONV(constFactorQtusMl,        multiply,      "qt" STD_US STD_RIGHT_ARROW "m" STD_litre,                            "qt" STD_US STD_RIGHT_ARROW                                ),
/* NNNN */  UNIT_CONV(constFactorTbspcFzus,       divide,      "Tbsp" STD_USc STD_RIGHT_ARROW "floz" STD_US,                         "Tbsp" STD_USc STD_RIGHT_ARROW                             ),
/* NNNN */  UNIT_CONV(constFactorTbspcMl,       multiply,      "Tbsp" STD_USc STD_RIGHT_ARROW "m" STD_litre,                         "Tbsp" STD_USc STD_RIGHT_ARROW                             ),
/* NNNN */  UNIT_CONV(constFactorTbspukFzuk,      divide,      "tbsp" STD_UK STD_RIGHT_ARROW "floz" STD_UK,                          "tbsp" STD_UK STD_RIGHT_ARROW                              ),
/* NNNN */  UNIT_CONV(constFactorTbspukMl,      multiply,      "tbsp" STD_UK STD_RIGHT_ARROW "m" STD_litre,                          "tbsp" STD_UK STD_RIGHT_ARROW                              ),
/* NNNN */  UNIT_CONV(constFactorTspcFzus,        divide,      "tsp" STD_USc STD_RIGHT_ARROW "floz" STD_US,                          "tsp" STD_USc STD_RIGHT_ARROW                              ),
/* NNNN */  UNIT_CONV(constFactorTspcMl,        multiply,      "tsp" STD_USc STD_RIGHT_ARROW "m" STD_litre,                          "tsp" STD_USc STD_RIGHT_ARROW                              ),
