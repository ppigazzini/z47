...
/* 1745 */  { fnVectorAngle,                NOPARAM,                     STD_MEASURED_ANGLE STD_SPACE_4_PER_EM STD_v_BAR "," STD_SPACE_4_PER_EM STD_v_BAR, STD_MEASURED_ANGLE STD_SPACE_4_PER_EM STD_v_BAR "," STD_SPACE_4_PER_EM STD_v_BAR, (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
...
/* 2472 */  { fnVectorDist,                 NOPARAM,                     "|" STD_SPACE_4_PER_EM STD_v_BAR "-" STD_v_BAR STD_SPACE_4_PER_EM "|", "|" STD_SPACE_4_PER_EM STD_v_BAR "-" STD_v_BAR STD_SPACE_4_PER_EM "|", (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
