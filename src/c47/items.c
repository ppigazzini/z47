...
/* 2556 */  { itemToBeCoded,                NOPARAM,                     "2556",                                        "2556",                                        (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_ENABLED  | PTP_NONE         | HG_ENABLED         },
/* 2557 */  { itemToBeCoded,                NOPARAM,                     "2557",                                        "2557",                                        (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_ENABLED  | PTP_NONE         | HG_ENABLED         },
...
/* 2562 */  { itemToBeCoded,                NOPARAM,                     "XXFNCS",                                      "XXFNCS",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_ENABLED  | PTP_NONE         | HG_ENABLED         },
