...
/* 1417 */  { fnBnStar,                     NOPARAM,                     "B" STD_N_ASTERISK STD_EQUALS_SH STD_SPACE_4_PER_EM "|B" STD_SUB_2 STD_SUB_n "|", "B" STD_N_ASTERISK STD_EQUALS_SH STD_SPACE_4_PER_EM "|B" STD_SUB_2 STD_SUB_n "|", (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_ENABLED  | PTP_NONE         | HG_ENABLED         },
