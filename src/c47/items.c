...
/* 2482 */  { fnRecallVElement,                   1,                     "RCLVEL1",                                     STD_ELLIPSIS "VEL" STD_SPACE_4_PER_EM "1",     (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2483 */  { fnRecallVElement,                   2,                     "RCLVEL2",                                     STD_ELLIPSIS "VEL" STD_SPACE_4_PER_EM "2",     (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2484 */  { fnRecallVElement,                   3,                     "RCLVEL3",                                     STD_ELLIPSIS "VEL" STD_SPACE_4_PER_EM "3",     (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2485 */  { fnStoreVElement,                    1,                     "STOVEL1",                                     STD_ELLIPSIS "VEL" STD_SPACE_4_PER_EM "1",     (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2486 */  { fnStoreVElement,                    2,                     "STOVEL2",                                     STD_ELLIPSIS "VEL" STD_SPACE_4_PER_EM "2",     (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2487 */  { fnStoreVElement,                    3,                     "STOVEL3",                                     STD_ELLIPSIS "VEL" STD_SPACE_4_PER_EM "3",     (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2488 */  { addItemToBuffer,              ITM_dddVEL,                  "",                                            STD_ELLIPSIS "VELnn",                          (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
