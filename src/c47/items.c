...
/* 2694 */  { fnP_PrintAllItems,               NOPARAM,                     STD_PRINTER "ITEMS",                           STD_PRINTER "ITEMS",                           (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     | HG_ENABLED         },
