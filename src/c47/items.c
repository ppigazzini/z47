...
/* 1899 */  { SetSetting,                   ITM_DREAL,                   "d" STD_SPACE_3_PER_EM "LI.0:",                 "d" STD_SPACE_3_PER_EM "LI.0",                (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },//JM INPUT DEFAULT
