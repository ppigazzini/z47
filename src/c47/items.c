...
/* 1782 */  { fnAddTimerApp,                NOPARAM,                     "ADD" STD_SUB_T STD_SIGMA,                     "ADD" STD_SUB_T STD_SIGMA,                     (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
/* 1783 */  { fnAddLapTimerApp,             NOPARAM,                     "ADD" STD_SUB_L STD_SIGMA,                     "ADD" STD_SUB_L STD_SIGMA,                     (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
/* 1784 */  { fnRegAddTimerApp,             NOPARAM,                     "ADD" STD_SUB_T "R",                           "ADD" STD_SUB_T "R",                           (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
/* 1785 */  { fnRegAddLapTimerApp,          NOPARAM,                     "ADD" STD_SUB_L "R",                           "ADD" STD_SUB_L "R",                           (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
...
/* 1871 */  { fnJM_2SI,                     NOPARAM,                     STD_RIGHT_ARROW "I",                           STD_RIGHT_ARROW "I",                           (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
