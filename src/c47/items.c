...
/* 1196 */  { fnTvmVar,                     RESERVED_VARIABLE_IPONA,     "i" STD_SPACE_6_PER_EM STD_pcPa,               "i" STD_SPACE_6_PER_EM STD_pcPa,               (0 << TAM_MAX_BITS) |     0, CAT_RVAR | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
/* 1197 */  { fnTvmVar,                     RESERVED_VARIABLE_NPPER,     "NP" PER_,                                     "NP" PER_,                                     (0 << TAM_MAX_BITS) |     0, CAT_RVAR | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
/* 1198 */  { fnTvmVar,                     RESERVED_VARIABLE_PPERONA,   "P" STD_PPa,                                   "P" STD_PPa,                                   (0 << TAM_MAX_BITS) |     0, CAT_RVAR | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
...
/* 1770 */  { fnRecall,                     RESERVED_VARIABLE_IPONA,     RCL_ "i" STD_SPACE_6_PER_EM STD_pcPa,          RCL_ "i" STD_SPACE_6_PER_EM STD_pcPa,          (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_DISABLED     },
/* 1771 */  { fnRecall,                     RESERVED_VARIABLE_NPPER,     RCL_ "NP" PER_,                                RCL_ "NP" PER_,                                (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_DISABLED     },
/* 1772 */  { fnRecall,                     RESERVED_VARIABLE_PPERONA,   RCL_ "P" STD_PPa,                              RCL_ "P" STD_PPa,                              (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_DISABLED     },
