...
/* 2279 */  { fnGetSystemFlag,              FLAG_PRTEN,                  "PRTEN",                                       "PRTEN",                                       (0 << TAM_MAX_BITS) |     0, CAT_SYFL | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     | HG_ENABLED         },
...
/* 2553 */  { itemToBeCoded,                NOPARAM,                     STD_PRINTER,                                   STD_PRINTER,                                   (0 << TAM_MAX_BITS) |     0, CAT_MENU | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     | HG_ENABLED         },
/* 2554 */  { fnP_Alpha,                    TM_REGISTER,                 STD_PRINTER STD_alpha,                         STD_PRINTER STD_alpha,                         (0 << TAM_MAX_BITS) |    99, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_REGISTER     | HG_ENABLED         },
/* 2555 */  { fnSetPrinter,                 PRINTER_HP,                  "82240",                                       "82240",                                       (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         | HG_ENABLED         },
...
/* 2559 */  { fnP_GetDelay,                 NOPARAM,                     STD_PRINTER "DLAY?",                           STD_PRINTER "DLAY?",                           (0 << TAM_MAX_BITS) |   127, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NUMBER_8     | HG_ENABLED         },
/* 2560 */  { fnP_PrinterOnOff,             PRON,                        STD_PRINTER "ON",                              STD_PRINTER "ON",                              (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         | HG_ENABLED         },
/* 2561 */  { fnP_PrinterOnOff,             PROFF,                       STD_PRINTER "OFF",                             STD_PRINTER "OFF",                             (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         | HG_ENABLED         },

/* 2562 */  { itemToBeCoded,                NOPARAM,                     "",                                            "Last item",                                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     | HG_ENABLED         },
