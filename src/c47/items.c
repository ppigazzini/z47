...
*/
  ...
  void fnCvtFlozukIn3             (uint16_t unusedButMandatoryParameter) {}
  void fnCvtFlozusIn3             (uint16_t unusedButMandatoryParameter) {}
  void fnCvtFt3toGalUS            (uint16_t unusedButMandatoryParameter) {}
...
/*  264 */  { fnCvtFlozukIn3,               divide,                      "in." STD_SUP_3 STD_RIGHT_ARROW "floz" STD_UK, "in." STD_SUP_3 STD_RIGHT_ARROW,               (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/*  265 */  { fnCvtFlozukIn3,               multiply,                    "floz" STD_UK STD_RIGHT_ARROW "in." STD_SUP_3, "floz" STD_UK STD_RIGHT_ARROW,                 (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
...
/*  267 */  { fnCvtFlozusIn3,               divide,                      "in." STD_SUP_3 STD_RIGHT_ARROW "floz" STD_US, "in." STD_SUP_3 STD_RIGHT_ARROW,               (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
...
/*  269 */  { fnCvtFlozusIn3,               multiply,                    "floz" STD_US STD_RIGHT_ARROW "in." STD_SUP_3, "floz" STD_US STD_RIGHT_ARROW,                 (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
...
/*  271 */  { fnCvtFt3toGalUS,              multiply,                    "ft." STD_SUP_3 STD_RIGHT_ARROW "gal" STD_US,  "ft." STD_SUP_3 STD_RIGHT_ARROW,               (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
...
/*  273 */  { fnCvtFt3toGalUS,              divide,                      "gal" STD_US STD_RIGHT_ARROW "ft." STD_SUP_3,  "gal" STD_US STD_RIGHT_ARROW,                  (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
