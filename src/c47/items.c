...
/* 1196 */  { fnTvmVar,                     RESERVED_VARIABLE_IPONA,     "i" STD_SPACE_6_PER_EM STD_pera,               "i" STD_SPACE_6_PER_EM STD_pera,               (0 << TAM_MAX_BITS) |     0, CAT_RVAR | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
