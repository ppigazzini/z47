...
/* 1202 */  { fnTvmVar,                     RESERVED_VARIABLE_CPERONA,    "CPER/a",                                       "CPER/a",                                       (0 << TAM_MAX_BITS) |     0, CAT_RVAR | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
/* 1203 */  { fnEditLinearEquationMatrixA,  NOPARAM,                     "Mat_A",                                       "Mat A",                                       (0 << TAM_MAX_BITS) |     0, CAT_RVAR | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
...
/* 1775 */  { fnRecall,                     RESERVED_VARIABLE_CPERONA,    STD_SUB_R STD_SPACE_3_PER_EM "CPER/a",          STD_SUB_R STD_SPACE_3_PER_EM "CPER/a",          (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_DISABLED     },
