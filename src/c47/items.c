...
/* 1779 */  { fnRecallTimerApp,             TM_REGISTER,                 "RCL" STD_SUP_T,                               "RCL" STD_SUP_T,                               (0 << TAM_MAX_BITS) |    99, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
...
/* 1844 */  { fnSetCountDownTimerApp,       TM_REGISTER,                 "RCL" STD_SUP_X,                               "RCL" STD_SUP_X,                               (0 << TAM_MAX_BITS) |    99, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
