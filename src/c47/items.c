...
/* 2041 */  { fnConvertMxToStk,             NOPARAM,                     "M" STD_RIGHT_ARROW "zyx",                     "M" STD_RIGHT_ARROW "zyx",                     (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_NONE         },
...
/* 2479 */  { fnRecallVElement,             1,                           "RCLVEL1",                                     STD_ELLIPSIS "V" STD_SUB_E STD_SUB_L "1",      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2480 */  { fnRecallVElement,             2,                           "RCLVEL2",                                     STD_ELLIPSIS "V" STD_SUB_E STD_SUB_L "2",      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2481 */  { fnRecallVElement,             3,                           "RCLVEL3",                                     STD_ELLIPSIS "V" STD_SUB_E STD_SUB_L "3",      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2482 */  { fnStoreVElement,              1,                           "STOVEL1",                                     STD_ELLIPSIS "V" STD_SUB_E STD_SUB_L "1",      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2483 */  { fnStoreVElement,              2,                           "STOVEL2",                                     STD_ELLIPSIS "V" STD_SUB_E STD_SUB_L "2",      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2484 */  { fnStoreVElement,              3,                           "STOVEL3",                                     STD_ELLIPSIS "V" STD_SUB_E STD_SUB_L "3",      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
