...
/* 1981 */  { fnToPolar_HP,                 NOPARAM,          STD_RIGHT_SHORT_ARROW "POLAR" STD_SUB_h STD_SUB_p,   STD_RIGHT_SHORT_ARROW "POLAR" STD_SUB_h STD_SUB_p,  (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 1982 */  { fnToRect_HP,                  NOPARAM,          STD_RIGHT_SHORT_ARROW "RECT"  STD_SUB_h STD_SUB_p,   STD_RIGHT_SHORT_ARROW "RECT"  STD_SUB_h STD_SUB_p,  (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 1983 */  { fnToPolar_CX,                 NOPARAM,          STD_RIGHT_SHORT_ARROW "POLAR" STD_SUB_c STD_SUB_x,   STD_RIGHT_SHORT_ARROW "POLAR" STD_SUB_c STD_SUB_x,  (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 1984 */  { fnToRect_CX,                  NOPARAM,          STD_RIGHT_SHORT_ARROW "RECT"  STD_SUB_c STD_SUB_x,   STD_RIGHT_SHORT_ARROW "RECT"  STD_SUB_c STD_SUB_x,  (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
