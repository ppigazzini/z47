...
/* 1896 */  { fnSigmaAssign,                16384+ITM_op_j,              "",                                            STD_RIGHT_DASHARROW STD_SPACE_4_PER_EM STD_op_i,                            (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
