...
/* 1854 */  { SetSetting,                   FLAG_HOME_TRIPLE,            "HOME.3",                                      "HOME.3",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     | HG_ENABLED         },//JM HOME.3
...
/* 1861 */  { SetSetting,                   FLAG_MYM_TRIPLE,             "MyM.3",                                       "MyM.3",                                       (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     | HG_ENABLED         },//JM MYM.3
...
/* 2279 */  { itemToBeCoded,                FLAG_BASE_MYM,               "MyMb",                                        "MyMb",                                        (0 << TAM_MAX_BITS) |     0, CAT_SYFL | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     | HG_ENABLED         },
/* 2280 */  { itemToBeCoded,                FLAG_G_DOUBLETAP,            "g.2Tp",                                       "g.2Tp",                                       (0 << TAM_MAX_BITS) |     0, CAT_SYFL | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     | HG_ENABLED         },
/* 2281 */  { itemToBeCoded,                FLAG_BASE_HOME,              "HOMEb",                                       "HOMEb",                                       (0 << TAM_MAX_BITS) |     0, CAT_SYFL | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     | HG_ENABLED         },
/* 2282 */  { itemToBeCoded,                FLAG_MYM_TRIPLE,             "MyM.3",                                       "MyM.3",                                       (0 << TAM_MAX_BITS) |     0, CAT_SYFL | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     | HG_ENABLED         },
/* 2283 */  { itemToBeCoded,                FLAG_HOME_TRIPLE,            "HOME.3",                                      "HOME.3",                                      (0 << TAM_MAX_BITS) |     0, CAT_SYFL | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     | HG_ENABLED         },
/* 2284 */  { itemToBeCoded,                FLAG_SHFT_4s,                "SH.4s",                                       "SH.4s",                                       (0 << TAM_MAX_BITS) |     0, CAT_SYFL | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     | HG_ENABLED         },
