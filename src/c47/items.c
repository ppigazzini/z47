...
/* 2227 */  { itemToBeCoded,                NOPARAM,                     "CAT_EIM",                                     "CAT",                                         (0 << TAM_MAX_BITS) |     0, CAT_MENU | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     | HG_ENABLED         },// DL
/* 2228 */  { itemToBeCoded,                NOPARAM,                     "FCNS_EIM",                                    "FCNS",                                        (0 << TAM_MAX_BITS) |     0, CAT_MENU | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     | HG_ENABLED         },// DL
...
/* 2552 */  { itemToBeCoded,                NOPARAM,                     STD_alpha "CAT",                               "CAT",                                         (0 << TAM_MAX_BITS) |     0, CAT_MENU | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     | HG_ENABLED         },// JM
