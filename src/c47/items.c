...
/* 2331 */  { fnStore,                      REGISTER_Q,                  "STO" STD_SUB_Q " " STD_nu,                    "STO" STD_SUB_Q " " STD_nu,                    (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2332 */  { itemToBeCoded,                NOPARAM,                     "2332",                                        "2332",                                        (0 << TAM_MAX_BITS) |     0, CAT_FREE | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
...
/* 2337 */  { addItemToBuffer,              REGISTER_N,                  "N",                                           "N",                                           (0 << TAM_MAX_BITS) |     0, CAT_REGS | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     }, // The
/* 2338 */  { addItemToBuffer,              REGISTER_P,                  "P",                                           "P",                                           (0 << TAM_MAX_BITS) |     0, CAT_REGS | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     }, // The
/* 2339 */  { addItemToBuffer,              REGISTER_Q,                  "Q",                                           "Q",                                           (0 << TAM_MAX_BITS) |     0, CAT_REGS | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     }, // The
