...
/* 2409 */  { fnEvPFacts,                   M_EULER_SIGMA_0,             "Eul." STD_sigma STD_SUB_0,                    "Eul." STD_sigma STD_SUB_0,                    (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2410 */  { fnEvPFacts,                   M_EULER_SIGMA_1,             "Eul." STD_sigma,                              "Eul." STD_sigma,                              (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2411 */  { fnEvPFacts,                   M_EULER_SIGMA_2,             "Eul." STD_sigma STD_SUB_k,                    "Eul." STD_sigma STD_SUB_k,                    (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2412 */  { itemToBeCoded,                NOPARAM,                     "EULER " STD_sigma,                            "EULER " STD_sigma,                            (0 << TAM_MAX_BITS) |     0, CAT_MENU | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
