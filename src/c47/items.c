...
/* 1899 */  { fnOutReal,                    ITM_OREAL,                   "d" STD_SPACE_3_PER_EM "REAL",                 "d" STD_SPACE_3_PER_EM "REAL",                 (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },//JM INPUT DEFAULT
