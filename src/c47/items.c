...
/*  480 */  { itemToBeCoded,                NOPARAM,                     "480",                                         "480",                                         (0 << TAM_MAX_BITS) |     0, CAT_FREE | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     | HG_ENABLED         },
/*  481 */  { itemToBeCoded,                NOPARAM,                     "481",                                         "481",                                         (0 << TAM_MAX_BITS) |     0, CAT_FREE | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     | HG_ENABLED         },
...
/* 2104 */  { fnKtoM,                       NOPARAM,                     "k" STD_RIGHT_ARROW "m",                       "k" STD_RIGHT_ARROW "m",                       (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         | HG_ENABLED         | RESULT_IN_X },
/* 2105 */  { fnMtoK,                       NOPARAM,                     "m" STD_RIGHT_ARROW "k",                       "m" STD_RIGHT_ARROW "k",                       (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         | HG_ENABLED         | RESULT_IN_X },
...
/* 2395 */  { fnEllipse,                    NOPARAM,                     "a,b" STD_RIGHT_ARROW "m",                     "a,b" STD_RIGHT_ARROW "m",                     (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         | HG_ENABLED         | RESULT_IN_X },
