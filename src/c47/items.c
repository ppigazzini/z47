...
/*  265 */  { fnCvtFlozukIn3,               multiply,                    "floz" STD_UK STD_RIGHT_ARROW "in" STD_SUB_3,  "floz" STD_UK STD_RIGHT_ARROW,                 (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
...
/*  269 */  { fnCvtFlozusIn3,               multiply,                    "floz" STD_US STD_RIGHT_ARROW "in" STD_SUB_3,  "floz" STD_US STD_RIGHT_ARROW,                 (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
