...
/* 1514 */  { allocateLocalRegisters,       TM_VALUE,                    "LocR",                                        "LocR",                                        (1 << TAM_MAX_BITS) |    99, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NUMBER_8     },
...
/* 1644 */  { fnXToDate,                    NOPARAM,                     "Y.MD" STD_RIGHT_ARROW DT,                     "Y.MD" STD_RIGHT_ARROW DT,                     (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
...
/* 1911 */  { itemToBeCoded/*fnFrom_ymd*/,                   NOPARAM,                     "Y.MD" STD_SUP_MINUS STD_SUP_1,                "Y.MD" STD_SUP_MINUS STD_SUP_1,                (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },//JM DMS HMS
