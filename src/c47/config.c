...
//********** JM CHECKQQ
    ...
    char testStr[1001];
    //350 primes product: strcpy(testStr,"");
    //100 primes product
    strcpy(testStr,"4711930799906184953162487834760260422020574773409675520188634839616415335845034221205289256705544681972439104097777157991804380284218315038719444943990492579030720635990538452312528339864352999310398481791730017201031090");

    longInteger_t testLI;
    longIntegerInit(testLI);
    stringToLongInteger(testStr,10,testLI);
    convertLongIntegerToLongIntegerRegister(testLI, 36);
