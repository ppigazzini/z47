...
InputDefaultDataType,                xxx,        xxx,                            ID_DP,           xxx,                  xxx,                    ID_43S,          xxx,             xxx,                  
...
MymB,                                xxx,        1,                              0,               xxx,                  xxx,                    1,               xxx,             xxx,                  
HomeB,                               xxx,        0,                              0,               xxx,                  xxx,                    0,               xxx,             xxx,                  
RNG,                                 xxx,        6145,                           99,              xxx,                  xxx,                    6145,            xxx,             xxx,                  
SDIGS,                               xxx,        0,                              16,              xxx,                  xxx,                    34,              xxx,             xxx,                  
DSTACK,                              xxx,        4,                              1,               xxx,                  xxx,                    4,               xxx,             xxx,                  
CACHEDDSTACK,                        xxx,        4,                              1,               xxx,                  xxx,                    4,               xxx,             xxx,                  
ADM,                                 xxx,        amDegree,                       amRadian,        amDegree,             amRadian,               amDegree,        xxx,             xxx,                  
IPGRP,                               xxx,        3,                              3,               xxx,                  xxx,                    _gprl,           xxx,             xxx,                  
FPGRP,                               xxx,        3,                              3,               xxx,                  xxx,                    _gprr,           xxx,             xxx,                  
IPGRP1,                              xxx,        0,                              0,               xxx,                  xxx,                    _gpr1,           xxx,             xxx,                  
IPGRP1x,                             xxx,        0,                              0,               xxx,                  1,                      _gpr1x,          xxx,             xxx,                  
ERPN,                                xxx,        1,                              0,               xxx,                  xxx,                    1,               xxx,             xxx,                  
fgLongPressSetting,                  xxx,        xxx,                            RB_FGLNOFF,      xxx,                  xxx,                    RB_FGLNFUL,      xxx,             xxx,                  
IRFRAC,                              xxx,        0,                              xxx,             xxx,                  0,                      xxx,             xxx,             xxx,                  
IRFRACMODE,                          xxx,        CF_NORMAL,                      xxx,             xxx,                  xxx,                    xxx,             xxx,             xxx,                  
IRFRACON,                            xxx,        0,                              xxx,             xxx,                  xxx,                    xxx,             xxx,             xxx,                  
DenMaX,                              xxx,        64,                             xxx,             xxx,                  9999,                   64,              xxx,             xxx,                  
...
3,                                   0,          FLAG_SBtime,                    xxx,             xxx,                  xxx,                    xxx,             FLAG_SBtime,     xxx,                  // Clear flag FLAG_SBtime
...
3,                                   0,          FLAG_FRACT,                     xxx,             xxx,                  xxx,                    xxx,             xxx,             xxx,                  // Clear flag FLAG_FRACT
3,                                   1,          FLAG_DENANY,                    xxx,             xxx,                  xxx,                    xxx,             xxx,             xxx,                  // Set flag  FLAG_DENANY
3,                                   1,          FLAG_MULTx,                     xxx,             xxx,                  xxx,                    xxx,             xxx,             xxx,                  // Set flag  FLAG_MULTx
3,                                   1,          FLAG_AUTOFF,                    xxx,             xxx,                  xxx,                    xxx,             xxx,             xxx,                  // Set flag  FLAG_AUTOFF
3,                                   1,          FLAG_ASLIFT,                    xxx,             xxx,                  xxx,                    xxx,             xxx,             xxx,                  // Set flag  FLAG_ASLIFT
...
3,                                   1,          xxx,                            xxx,             xxx,                  FLAG_DENANY,            xxx,             xxx,             xxx,                  // Set flag  FLAG_DENANY
3,                                   0,          FLAG_ASLIFT,                    xxx,             xxx,                  xxx,                    xxx,             xxx,             xxx,                  // Clear flag FLAG_ASLIFT
3,                                   0,          FLAG_DENFIX,                    xxx,             xxx,                  xxx,                    xxx,             xxx,             xxx,                  // Clear flag FLAG_DENFIX
  ...
  while(Settings[++ptr*(_numberOfGrps+2) + 0] != 0) {
    if(Settings[  ptr*(_numberOfGrps+2) + 1 + grp] != xxx) {
      ...
      switch (Settings[ptr*(_numberOfGrps+2) + 0]) {
        case 101: {fnInDefault                  (Settings[ptr*(_numberOfGrps+2) + 1 + grp]);break;}                       // InputDefaultDataType 
        case 102: {fnDisplayFormatSigFig        (Settings[ptr*(_numberOfGrps+2) + 1 + grp]);break;}                       // SigFigNumberOfDigits 
        case 103: {fnDisplayFormatAll           (Settings[ptr*(_numberOfGrps+2) + 1 + grp]);break;}                       // AllNumberOfDigits    
        case 104: {fnDisplayFormatFix           (Settings[ptr*(_numberOfGrps+2) + 1 + grp]);break;}                       // FixNumberOfDigits    
        case 105: {BASE_MYM  =                  (Settings[ptr*(_numberOfGrps+2) + 1 + grp]) == 1 ? true : false;break;}   // MymB                 
        case 106: {BASE_HOME =                  (Settings[ptr*(_numberOfGrps+2) + 1 + grp]) == 1 ? true : false;break;}   // HomeB                
        case 107: {exponentLimit      =         (Settings[ptr*(_numberOfGrps+2) + 1 + grp]);break;}                       // RNG                  
        case 108: {significantDigits  =         (Settings[ptr*(_numberOfGrps+2) + 1 + grp]);break;}                       // SDIGS                
        case 109: {displayStack       =         (Settings[ptr*(_numberOfGrps+2) + 1 + grp]);break;}                       // DSTACK               
        case 110: {cachedDisplayStack =         (Settings[ptr*(_numberOfGrps+2) + 1 + grp]);break;}                       // CACHEDDSTACK         
        case 111: {currentAngularMode =         (Settings[ptr*(_numberOfGrps+2) + 1 + grp]);break;}                       // ADM                  
        case 112: {grpGroupingLeft            = (Settings[ptr*(_numberOfGrps+2) + 1 + grp]);break;}                       // IPGRP                
        case 113: {grpGroupingRight           = (Settings[ptr*(_numberOfGrps+2) + 1 + grp]);break;}                       // FPGRP                
        case 114: {grpGroupingGr1Left         = (Settings[ptr*(_numberOfGrps+2) + 1 + grp]);break;}                       // IPGRP1               
        case 115: {grpGroupingGr1LeftOverflow = (Settings[ptr*(_numberOfGrps+2) + 1 + grp]);break;}                       // IPGRP1x              
        case 116: {fneRPN                       (Settings[ptr*(_numberOfGrps+2) + 1 + grp]);break;}                       // ERPN                 
        case 117: {setFGLSettings               (Settings[ptr*(_numberOfGrps+2) + 1 + grp]);break;}                       // fgLongPressSetting   
        case 118: {constantFractions          = (Settings[ptr*(_numberOfGrps+2) + 1 + grp]) == 1 ? true : false;break;}   // IRFRAC               
        case 119: {constantFractionsMode      = (Settings[ptr*(_numberOfGrps+2) + 1 + grp]);break;}                       // IRFRACMODE           
        case 120: {constantFractionsOn        = (Settings[ptr*(_numberOfGrps+2) + 1 + grp]) == 1 ? true : false;break;}   // IRFRACON             
        case 121: {denMax                     = (Settings[ptr*(_numberOfGrps+2) + 1 + grp]);break;}                       // DenMaX               
