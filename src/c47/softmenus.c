...
TO_QSPI const int16_t menu_ASN_N[]       = { ITM_N_KEY_SIGMA,               ITM_N_KEY_USER,             ITM_N_KEY_ALPHA,          ITM_N_KEY_FGSH,        ITM_N_KEY_GSH,               ITM_FROM_USER,
  ...
  #define CC_D47  ITM_NULL     //ITM_USER_D47       depreciated, replaced with R47
  #define CC_N47  ITM_NULL
#elif defined (PC_BUILD)
  #define CC_V47  ITM_NULL     //ITM_USER_V47
  #define CC_E47  ITM_NULL     //ITM_USER_E47
  #define CC_D47  ITM_NULL     //ITM_USER_D47       depreciated, replaced with R47
  #define CC_N47  ITM_NULL     //ITM_USER_N47
#endif // PC_BUILD
...
TO_QSPI const int16_t menu_LAYOUTS[]   =  {  ITM_USER_C47,              ITM_USER_R47,              ITM_USER_DM42,             ITM_KEYMAP,                ITM_USERMODE,              ITM_ASSIGN,
                                             ITM_USER_R47fgbk,          ITM_USER_R47fg_g,          ITM_USER_R47bkfg,          ITM_NULL,                  ITM_NULL,                  ITM_NULL,                  
                                             CC_E47,                    CC_N47,                    CC_V47,                    CC_D47,                    ITM_NULL,                  ITM_NULL,                  };
