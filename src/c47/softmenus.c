...
TO_QSPI const int16_t menu_CLK[]         = { ITM_TIME,                      ITM_DTtoJ,                  ITM_JtoDT,                ITM_DtoJ,              ITM_DATE,                    ITM_TIMER,
                                             ITM_TIMEto,                    ITM_msTo,                   ITM_dotD,                 ITM_ymdTo,             ITM_DATEto,                  ITM_LEAP,
                                             ITM_toTIME,                    ITM_HMStoTM,                ITM_HRtoTM,               ITM_XtoDATE,           ITM_toDATE,                  ITM_NULL,
