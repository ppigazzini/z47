...
/* 069 */  {.menuItem = -MNU_PLOT_RANGE,  .numItems = sizeof(menu_PLOT_RANGE    )/sizeof(int16_t), .softkeyItem = menu_PLOT_RANGE     },       // NOTE !! do not add menus here, add them at the end. The menu numbers are fixed for the Wiki references. 2024-02-21 jm
