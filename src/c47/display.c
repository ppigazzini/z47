...
printReal34ToConsole(real34, "Irfrac: ","\n");
  if(limitIrfrac >= LIMITIRFRAC) {
    if(getSystemFlag(FLAG_IRFRAC) && IrFractionsCurrentStatus != CF_OFF && !real34CompareAbsLessThan(real34,const34_1e_24) && !real34IsAnInteger(real34)) {
      ...
      if((limitIrfrac >= LIMITIRFRAC && runningOnSimOrUSB) || limitIrfrac == FULLIRFRAC) {
