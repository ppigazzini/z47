...
#define is3dVectorPolarSPH(tag)     ( ((getTagAngularMode(tag)) != amNone) && is2dVectorPolar(tag) )
#define is3dVectorPolarCYL(tag)     ( ((getTagAngularMode(tag)) != amNone) && !is2dVectorPolar(tag) )
