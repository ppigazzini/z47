...
#define NUMBER_OF_DISPLAY_REAL_CONTEXT_DIGITS     ((displayFormat == DF_ALL || getSystemFlag(FLAG_2TO10)) ? 21 : displayFormatDigits + 3)   //used for transcentantal functions, divides, etc.
