...
#define VERSION1 "0.109.00.04a11"     // major release . minor release . tracked build . internal OR un/tracked OR subrelease : Alpha / Beta / RC1
...
#define NUMBER_OF_SYSTEM_FLAGS                    65 // We can have a maximum of 128 system flags
