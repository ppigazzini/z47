...
pub const CONFIG_FILE_VERSION: u32 = 10000029; // C saveRestoreCalcState.c:7 configFileVersion (GRAMOD moved from the reserved variable table to the graMod global)
