...
fn ixyz() callconv(.c) void {
    ...
    if (runtime.getRegisterAsReal(runtime.REGISTER_X, &x_value) and runtime.getRegisterAsReal(runtime.REGISTER_Y, &a_value) and runtime.getRegisterAsReal(runtime.REGISTER_Z, &b_value)) {
        if (runtime.realCompareGreaterEqual(&x_value, runtime.z47_math_wrappers_const_0()) and
            runtime.realCompareLessEqual(&x_value, runtime.z47_math_wrappers_const_1()) and
            runtime.realCompareGreaterThan(&a_value, runtime.z47_math_wrappers_const_0()) and
            runtime.realCompareGreaterThan(&b_value, runtime.z47_math_wrappers_const_0()))
        {
