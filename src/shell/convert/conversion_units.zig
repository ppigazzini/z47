...
const conversionFactorOffsets = [_]?u32{
    ...
    3344, // 7 constFactorBarPa = const_BarToPa
    3164, // 8 constFactorBtuJ = const_BtuToJ
    3148, // 9 constFactorCalJ = const_CalToJ
    3440, // 10 constFactorLbfftNm = const_LbfftToNm
    2804, // 11 constFactorCwtKg = const_CwtToKg
    1932, // 12 constFactorFtM = const_FtToM
    1980, // 13 constFactorSfeetM = const39_SfeetToM
    2548, // 14 constFactorFlozukIn3 = const39_FlozukToIn3
    2512, // 15 constFactorFlozukMl = const_FlozukToMl
    2584, // 16 constFactorFlozusIn3 = const_FlozusToIn3
    2528, // 17 constFactorFlozusMl = const_FlozusToMl
    2600, // 18 constFactorFt3toGalUS = const39_Ft3ToGalUS
    2656, // 19 constFactorGalukL = const_GalukToL
    2636, // 20 constFactorGalusL = const_GalusToL
    3412, // 21 constFactorHpeW = const_HpeToW
    3372, // 22 constFactorHpmW = const_HpmToW
    3388, // 23 constFactorHpukW = const_HpukToW
    3292, // 24 constFactorInhgPa = const_InhgToPa
    1920, // 25 constFactorInchMm = const_InchToMm
    3184, // 26 constFactorWhJ = const_WhToJ
    2756, // 27 constFactorLbKg = const_LbToKg
    2720, // 28 constFactorOzG = const_OzToG
    2788, // 29 constFactorShortcwtKg = const_ShortcwtToKg
    ...
    4160, // 67 constFactorInchCm = const_InchToCm
    2100, // 68 constFactorNmiMi = const39_NmiToMi
    3464, // 69 constFactorFurtom = const_furToM
    3480, // 70 constFactorFtntos = const_ftnToS
    3496, // 71 constFactorFpftomps = const39_fpfToMps
    3532, // 72 constFactorBrdstom = const_brdsTom
    3544, // 73 constFactorFirtokg = const_firToKg
    3560, // 74 constFactorFpftokph = const39_fpfToKph
    3596, // 75 constFactorBrdstoin = const39_brdsToIn
    3632, // 76 constFactorFirtolb = const_firToLb
    ...
    3756, // 92 constFactorCupukMl = const_CupukMl
    3744, // 93 constFactorFzukCupuk = const_CupukFzuk
    3772, // 94 constFactorFzukTbspuk = const_FzukTbspuk
    3784, // 95 constFactorFzukTspuk = const_FzukTspuk
    3712, // 96 constFactorFzusCupc = const_CupcFzus
    3796, // 97 constFactorFzusTbspc = const_FzusTbspc
    3808, // 98 constFactorFzusTspc = const_FzusTspc
    3724, // 99 constFactorMlCupc = const_CupcMl
    3756, // 100 constFactorMlCupuk = const_CupukMl
    3820, // 101 constFactorMlPintlq = const_PintlqMl
    3836, // 102 constFactorMlPintuk = const_PintukMl
    3852, // 103 constFactorMlQt = const_QtMl
    3868, // 104 constFactorMlQtus = const_QtusMl
    3884, // 105 constFactorMlTbspc = const_TbspcMl
    3904, // 106 constFactorMlTbspuk = const_TbspukMl
    3924, // 107 constFactorMlTspc = const_TspcMl
    3944, // 108 constFactorMlTspuk = const39_TspukMl
    3820, // 109 constFactorPintlqMl = const_PintlqMl
    3836, // 110 constFactorPintukMl = const_PintukMl
    3852, // 111 constFactorQtMl = const_QtMl
    3868, // 112 constFactorQtusMl = const_QtusMl
    3796, // 113 constFactorTbspcFzus = const_FzusTbspc
    3884, // 114 constFactorTbspcMl = const_TbspcMl
    3772, // 115 constFactorTbspukFzuk = const_FzukTbspuk
    3904, // 116 constFactorTbspukMl = const_TbspukMl
    3808, // 117 constFactorTspcFzus = const_FzusTspc
    3924, // 118 constFactorTspcMl = const_TspcMl
    3784, // 119 constFactorTspukFzuk = const_FzukTspuk
    3944, // 120 constFactorTspukMl = const39_TspukMl
    3980, // 121 constFactorMlIn3 = const_In3Ml
    3980, // 122 constFactorIn3Ml = const_In3Ml
    3996, // 123 constFactorFt3Gluk = const_Ft3Gluk
    3996, // 124 constFactorGlukFt3 = const_Ft3Gluk
    4032, // 125 constFactorLFt3 = const_Ft3L
    4032, // 126 constFactorFt3L = const_Ft3L
    4052, // 127 constFactorLQtus = const39_LQtus
    4052, // 128 constFactorQtusL = const39_LQtus
    4088, // 129 constFactorGlukFzuk = const_GlukFzuk
    4088, // 130 constFactorFzukGluk = const_GlukFzuk
    4100, // 131 constFactorGlusFzus = const_GlusFzus
    4100, // 132 constFactorFzusGlus = const_GlusFzus
    156, // 133 constFactoreVJ = const_e
    156, // 134 constFactorJeV = const_e
    4112, // 135 constFactormmBanana = const_bananamm
    4112, // 136 constFactorBananamm = const_bananamm
    4124, // 137 constFactorInchBanana = const39_bananaInch
    4124, // 138 constFactorBananaInch = const39_bananaInch
    ...
    4352, // 151 constFactorKsiMpa = const39_KsiToMpa
    4256, // 152 constFactorLbsBlob = const39_BlobInLbs
    4388, // 153 constFactorLbsin3Tmm3 = const39_Lbsin3ToTmm3
    4424, // 154 constFactorLbsin3Kgm3 = const39_Lbsin3ToKgm3
    4460, // 155 constFactorKgm3Blobin3 = const39_Kgm3ToBlobin3
    4824, // 156 constFactorKgm3Tmm3 = const_1e_12
    4496, // 157 constFactorLbsftKgm = const39_LbsftToKgm
    4532, // 158 constFactorIn3Mm3 = const_In3ToMm3
    4548, // 159 constFactorIn2Mm2 = const_In2ToMm2
    4564, // 160 constFactorIn4Mm4 = const_In4ToMm4
    4584, // 161 constFactorIn6Mm6 = const_In6ToMm6
    436, // 162 constFactorKgmNpm = const_gEarth
    4240, // 163 constFactorInchM = const_InchToM
    2756, // 164 constFactorLbfKgf = const_LbToKg
    2896, // 165 constFactorMphKnot = const39_MphToKnot
    2932, // 166 constFactorMphFps = const39_MphToFps
    3040, // 167 constFactorMgeusK100K = const39_MgeusToK100K
...
const MimFunctionsType3Conv = [NUM_CONVERT_PAIRS]fInMim_t{
    ...
    .{ .itemNr = 2864 }, // ITM_MGEUStoK100K
    .{ .itemNr = 2865 }, // ITM_K100KtoMGEUS
    .{ .itemNr = 2866 }, // ITM_MGEUKtoK100K
    .{ .itemNr = 2867 }, // ITM_K100KtoMGEUK
    .{ .itemNr = 2868 }, // ITM_MIKtoK100K
    .{ .itemNr = 2869 }, // ITM_K100KtoMIK
    .{ .itemNr = 2870 }, // ITM_DEGtoMIL
    .{ .itemNr = 2871 }, // ITM_MILtoDEG
    .{ .itemNr = 2872 }, // ITM_DEGtoARCSEC
