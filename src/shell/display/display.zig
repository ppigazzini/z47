...
const numeral_grouping = @import("../../core/text/numeral_grouping.zig"); // std-only digit-group separator math
const fraction_encode = @import("../convert/fraction_encode.zig"); // std-only fraction glyph encoder
const word_break = @import("../../core/text/word_break.zig"); // std-only display word-break trim
const gap_char_codec = @import("../../core/text/gap_char_codec.zig"); // std-only gap-char normalization
const integer_separators = @import("../../core/text/integer_separators.zig"); // std-only integer separator splice
...
const const39_root2 = constR(5184);
...
// Moved to the base kernel (engine/kernel/long_integer_format.zig).
pub extern fn longIntegerToAllocatedString(lgInt: [*c]const mpz_struct, str: [*c]u8, strLen: i32) callconv(.c) void;
