...
const INVALID_MENU = 3244; // items.h: LAST_ITEM
...
const menu_TVM linksection(code_section) = [_]i16{ 1197, 1196, 1200, 1199, 1195, 1198, 1452, 1776, 1781, 0, 0, 2379, 1415, 1459, 2197, 0, 0, -3011 };
...
const menu_TamRclTVM linksection(code_section) = [_]i16{ 2640, 2641, 2642, 2644, 2643, 1198, 0, 0, 0, 0, 0, 2379, 539, -3138, 2655, 2654, 0, -3112 };
...
const menu_TamStoTVM linksection(code_section) = [_]i16{ 2640, 2641, 2642, 2644, 2643, 1198, 0, 0, 0, 0, 0, 2379, 539, -3138, 2655, 2654, 0, -3112 };
