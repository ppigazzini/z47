...
const menu_MyPFN linksection(code_section) = [_]i16{ 1, 2, 3, 4, 1458, -3096, 0, 0, 0, -2923, -3078, -3129, 2404, 0, 0, 0, -3098, -3097 };
...
const menu_CLR linksection(code_section) = [_]i16{ 1429, 1424, 1420, 2773, 41, 1428, 1421, 2239, 2240, 2771, 2772, 1427, 1568, 2005, 1452, 2033, 2937, -3049 };
...
const menu_STRUCTPGM linksection(code_section) = [_]i16{ 2920, 2921, 2922, 2924, 2925, 2926, 2927, 2933, 2938, 2928, 2935, 2936, 2937, -3078, -3129, 0, 2932, 2931 };
...
const menu_Misc linksection(code_section) = [_]i16{ 367, 368, 2887, 2888, 231, 225, 349, 348, 2885, 2886, 228, 222, 254, 252, 2880, 2881, 0, 0 };
...
const menu_PFN_3 linksection(code_section) = [_]i16{ 1, 2, 3, 4, 1458, -3095, 1603, 1412, 2223, 1579, -3078, -3129, 2404, 1418, 2224, 0, -2923, 2055 };
...
pub export const softmenu linksection(code_data_section) = [_]softmenu_t{
    ...
    .{ .menuItem = -2923, .numItems = @as(i16, @intCast(menu_STRUCTPGM.len)), .softkeyItem = &menu_STRUCTPGM },
