...
TO_QSPI const calcKey_t kbd_std_R47[37] = {
  ...
  {22,                  ITM_SQUAREROOTX,      ITM_op_j_pol,         ITM_toPOL2,           ITM_ROOT_SIGN,        ITM_B,                ITM_b,                ITM_CIRCUMFLEX,       ITM_REG_B           },
  {23,                  ITM_1ONX,             ITM_XFACT,            ITM_ms,               ITM_NULL,             ITM_C,                ITM_c,                ITM_pi,               ITM_REG_C           },
  {24,                  ITM_YX,               ITM_XTHROOT,          ITM_dotD,             ITM_NULL,             ITM_D,                ITM_d,                ITM_ROOT_SIGN,        ITM_REG_D           },
  ...
  {31,                  ITM_STO,              ITM_MAGNITUDE,        ITM_ARG,              ITM_NULL,             ITM_G,                ITM_g,                ITM_VERTICAL_BAR,     ITM_NULL            },
  {32,                  ITM_RCL,              ITM_PC,               ITM_DELTAPC,          ITM_NULL,             ITM_H,                ITM_h,                ITM_DELTA,            ITM_HEX             },
  {33,                  ITM_Rdown,            ITM_CONSTpi,          ITM_Rup,              ITM_NULL,             ITM_I,                ITM_i,                ITM_EXCLAMATION_MARK, ITM_REG_I           },
