...
TO_QSPI const int16_t menu_VARS[]        = { -MNU_NUMBRS,                  -MNU_LINTS,                 -MNU_SINTS,                -MNU_REALS,            -MNU_CPXS,                   -MNU_ALLVARS,
                                             -MNU_ANGLES,                  -MNU_CONFIGS,               -MNU_DATES,                -MNU_MATRS,            -MNU_STRINGS,                -MNU_TIMES                    };
